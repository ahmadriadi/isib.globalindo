...
class Home extends CI_Controller {
    ...
    function excel($idemployee, $fromdate, $untildate) {
        ...
        $objSheet->getStyle('A1:T9')->getFont()->setBold(true)->setSize(10);
        // write header
        ...
        $objSheet->getCell('T9')->setValue('NOTE');
        ...
        $P_Count = $PLW_Count = $A_Count = $SP_Count = $SN_Count = $L_Count = $leavepermit_Count = $OT_Count = $NC_Count = $ALD_Count = 0;
        ...
        if ($checkdata == 'exist') {
            foreach ($resuldata as $row) {
                ...
                $p = $plw = $a = $sp = $sn = $l = $leavepermit = $ot = $nc = $ald = '';
                ...
                $objSheet->getCell('T' . $i)->setValue($note);
            }
            $i++;
            $objSheet->getStyle('A' . $i . ':T' . $i)->getFont()->setBold(true)->setSize(10);
        ...
        $objSheet->getStyle('A8:T' . $i)->getBorders()->
