...
//===========END PASSIVE OR ACTIVE======================    
    ...
    function exportdata($param, $group, $loc, $ext = '.xlsx', $path_file = '/tmp/') {
        ...
        $objSheet->getStyle('A1:AY1')->getFont()->setBold(true)->setSize(12);
        ...
        $objSheet->getCell('O1')->setValue('Start Probation Date');
        $objSheet->getCell('P1')->setValue('Pass Probation Date');
        $objSheet->getCell('Q1')->setValue('New Contact Date');
        $objSheet->getCell('R1')->setValue('End Contact Date');
        $objSheet->getCell('S1')->setValue('In Field Date');
        $objSheet->getCell('T1')->setValue('Birth Place');
        $objSheet->getCell('U1')->setValue('Birth Date');
        $objSheet->getCell('V1')->setValue('Gender');
        $objSheet->getCell('W1')->setValue('Religion');
        $objSheet->getCell('X1')->setValue('Education Level');
        $objSheet->getCell('Y1')->setValue('Education School');
        $objSheet->getCell('Z1')->setValue('Education Majors');
        $objSheet->getCell('AA1')->setValue('Marital Status');
        $objSheet->getCell('AB1')->setValue('Marriage Certificate');
        $objSheet->getCell('AC1')->setValue('Family Member Certificate');
        $objSheet->getCell('AD1')->setValue('ID Family Certificate');
        $objSheet->getCell('AE1')->setValue('NPWP');
        $objSheet->getCell('AF1')->setValue('KPJ');
        $objSheet->getCell('AG1')->setValue('Citized Card(KTP)');
        $objSheet->getCell('AH1')->setValue('ID Married Couple');
        $objSheet->getCell('AI1')->setValue('Certificate AKDHK No.');
        $objSheet->getCell('AJ1')->setValue('Number of Children');
        $objSheet->getCell('AK1')->setValue('First Child');
        $objSheet->getCell('AL1')->setValue('Second Child');
        $objSheet->getCell('AM1')->setValue('Couple Name');
        $objSheet->getCell('AN1')->setValue('Blood Type');
        $objSheet->getCell('AO1')->setValue('Telphone');
        $objSheet->getCell('AP1')->setValue('Handphone');
        $objSheet->getCell('AQ1')->setValue('Address (Current)');
        $objSheet->getCell('AR1')->setValue('Address (KTP)');
        $objSheet->getCell('AS1')->setValue('Work Experience');
        $objSheet->getCell('AT1')->setValue('Resign Date');
        $objSheet->getCell('AU1')->setValue('Reason Explain Resignation');
        $objSheet->getCell('AV1')->setValue('Employee Status');
        $objSheet->getCell('AW1')->setValue('Status');
        $objSheet->getCell('AY1')->setValue('Note');
        ...
        if ($result != NULL) {
            ...
            foreach ($array as $row) {
                ...
                $objSheet->getCell('O' . $i)->setValue($startprobdate);
                $objSheet->getCell('P' . $i)->setValue($passdate);
                $objSheet->getCell('Q' . $i)->setValue($newdate);
                $objSheet->getCell('R' . $i)->setValue($enddate);
                $objSheet->getCell('S' . $i)->setValue($fielddate);
                $objSheet->getCell('T' . $i)->setValue($row['BirthPlace']);
                $objSheet->getCell('U' . $i)->setValue($bdate);
                $objSheet->getCell('V' . $i)->setValue($jk);
                $objSheet->getCell('W' . $i)->setValue($row['Religion']);
                $objSheet->getCell('X' . $i)->setValue($edu);
                $objSheet->getCell('Y' . $i)->setValue($school);
                $objSheet->getCell('Z' . $i)->setValue($major);
                $objSheet->getCell('AA' . $i)->setValue($row['MaritalStatus']);
                $objSheet->getCell('AB' . $i)->setValue($row['MarriageCertificate']);
                $objSheet->getCell('AC' . $i)->setValue($row['FamilyMemberCertificate']);
                $objSheet->getCell('AD' . $i)->setValue("'" . $row['NoFamCert']);
                $objSheet->getCell('AE' . $i)->setValue("'" . $row['NoNPWP']);
                $objSheet->getCell('AF' . $i)->setValue("'" . $row['NoKPJ']);
                $objSheet->getCell('AG' . $i)->setValue("'" . $row['NoKTP']);
                $objSheet->getCell('AH' . $i)->setValue("'" . $row['CoupleKTP']);
                $objSheet->getCell('AI' . $i)->setValue("'" . $row['NoAKDHK']);
                $objSheet->getCell('AJ' . $i)->setValue($row['NumberChildren']);
                $objSheet->getCell('AK' . $i)->setValue($row['FirstChild']);
                $objSheet->getCell('AL' . $i)->setValue($row['SecondChild']);
                $objSheet->getCell('AM' . $i)->setValue($row['CoupleName']);
                $objSheet->getCell('AN' . $i)->setValue($row['BloodType']);
                $objSheet->getCell('AO' . $i)->setValue("'" . $row['NoTelp']);
                $objSheet->getCell('AP' . $i)->setValue("'" . $row['NoHp']);
                $objSheet->getCell('AQ' . $i)->setValue($row['LiveAddress']);
                $objSheet->getCell('AR' . $i)->setValue($row['KTPAddress']);
                $objSheet->getCell('AS' . $i)->setValue($row['WorkExperience']);
                $objSheet->getCell('AT' . $i)->setValue($row['ResignDate']);
                $objSheet->getCell('AU' . $i)->setValue($row['ReasonResign']);
                $objSheet->getCell('AV' . $i)->setValue($row['EmployeeStatus']);
                $objSheet->getCell('AW' . $i)->setValue($row['Status']);
                $objSheet->getCell('AY' . $i)->setValue($row['Note']);
            }
