   ...
   function autocomplete_employee() {
    ...
    function reportdata($group, $from, $until, $name = '') {
        ...
        if ($cekdata !== 'empty') {
            ...
            $data['url_excel'] = site_url('rpt14/home/dataexcel' . '/' . $group . '/' . $from . '/' . $until . '/' . $name);
    ...
    function dataexcel($group, $fromdate, $untildate, $nip) {
        ...
        $excel->getProperties()->setCreator("PHP Excel")
                ...
                ->setTitle("DATA SUMMARY ABSENCE STAFF")
                ->setSubject("DATA SUMMARY ABSENCE STAFF")
                ->setDescription("DATA SUMMARY ABSENCE STAFF")
                ->setKeywords("DATA SUMMARY ABSENCE STAFF")
                ->setCategory("DATA SUMMARY ABSENCE STAFF");
...
//add header      
        ...
        $worksheet->getCell('A10')->setValue('REPORT SUMMARY ABSENCE STAFF');
...
//add style		
        ...
        header('Content-Disposition: attachment;filename="summaryabsencestaff.xlsx"');
