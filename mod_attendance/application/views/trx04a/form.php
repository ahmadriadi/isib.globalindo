                ...
                <div class="widget-body">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            ...
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f03">Official Travel Date</label>
                                <div class="controls">
                        ...
                        <div class="span6">                           
                            ...
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f05">Vehicle No</label>
                                <div class="controls">
...
<script type="text/javascript">
	...
	/*
        var url_suggest = '<?php echo site_url('trx04a/home/suggest_employee'); ?>';
        $("#f02").autocomplete({
            minLength: 2,
