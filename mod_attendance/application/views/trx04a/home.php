    ...
    <div class="widget-body">
        ...
        <table width='100%' id="officialtravel" class="table table-bordered table-condensed table-striped table-primary table-vertical-center js-table-sortable" >
            ...
            <tbody>
                <?php
                $i = 0;
                foreach ($dataofficialtravel as $row) {
                    $i++;
                    $jg = $row['IDJobGroup'];
                    ...
                    echo "<td>" . $group . "</td>";
                    echo "<td>" . $row['OfficialTravelDate'] . "</td>";
                    echo "<td>" . $row['UntilDate'] . "</td>";
                        ...
                        if (button == 'btn_add') {
                            ...
                            $(document).ready(function()
                            {
                                if (status == '1' && inputby == 'emp') {
                                    ...
                                    // alert('<?php //echo site_url('trx04a/home/delete')   ?>'+'/'+id);
                            ...
                            window.location.href = '<?php echo site_url('trx04a/home/exportdata') ?>';
