...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data Sickness Leave</h4>                
            </div>
    ...
    <script type="text/javascript">
			<?php
				...
				?>
                    ...
                    function reloadpage() {
                        ...
                        var url = ROOT.base_url + 'mod_attendance/index.php/trx08/home/';
                        //alert(url);
                        content.load(url);
                    }
                    function backtohome() {
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('trx08/home/datasickleave') ?>';
			    ...
			    "sPaginationType2": "bootstrap", 
                            ...
                            "aoColumns": [
                                ...
                                {"mData": "IDPengganti", "sTitle": "Person in Charge", "sClass": "left"},
                                ...
                                {"mData": "SickLetter", "sTitle": "Sick Letter", "sClass": "left"},
                            ...
                            "fnDrawCallback": function(oSettings) {
                                $("#tableajax tbody tr ").on('click', 'button', function() {
                                    ...
                                    $.ajax(
                                            {
                                                type: "POST",
                                                url: '<?php echo site_url('trx08/home/block_leave') ?>',
                                                dataType: "json",
                                                data: "id=" + id,
                                                cache: false,
                                                success:
				 ...
				 $("#tableajax tbody tr ").on('mouseenter', 'button', function() {
                                    ...
                                    $.ajax(
                                            {
                                                type: "POST",
                                                url: '<?php echo site_url('trx08/home/get_access') ?>',
                                                dataType: "json",
                                                data: "btn=" + button,
                                                cache: false,
                                                success:
			...
			var group = $("#group").val();
                        ...
                        if (button == 'btn_add') {
                            var content = $("#content");
                            var site = "mod_attendance/index.php/trx08/home/addnew";
                            var url = ROOT.base_url + site;
                            content.load(url);
                        } else if (button == 'btn_edit') {
                            var content = $("#content");
                            var site = "mod_attendance/index.php/trx08/home/edit";
                                        ...
                                        $("#dialog-confirm").dialog({
                                            ...
                                            buttons: {
                                                "Delete ": function() {
                                                    $.ajax({
                                                        type: "POST",
                                                        url: '<?php echo site_url('trx08/home/delete') ?>' + '/' + id,
                                                        dataType: "json",
                                                        cache: false,
                                                        success:
                                                                function(data) {
                            ...
                            $(document).ready(function()
                            {
                                var url_print = '<?php echo site_url('trx08/home/iframe') ?>';
                                //alert(url_print + "/" + id);
                                $.ajax({
                                    type: "POST",
                                    url: url_print + "/" + id,
