...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data Parameter</h4>                
            </div>
...
?>
                    ...
                    function reloadpage() {
                        ...
                        var url = ROOT.base_url + 'mod_attendance/index.php/ref04/home/';
                        //alert(url);
                        content.load(url);
                    }
                    function backtohome() {
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('ref04/home/getdatatable') ?>';
                        ...
                        var oTable = $('#tableajax').dataTable({
                            ...
                            "aoColumns": [
                                ...
                                {"mData": "IDParam", "sTitle": "Parameter", "sClass": "left"},
                                {"mData": "Val1", "sTitle": "Fromdate", "sClass": "left"},
                                {"mData": "Val2", "sTitle": "Untildate", "sClass": "left"},
                                {"mData": "FullName", "sTitle": "User Exclude", "sClass": "left"},
                                {"mData": "Val4", "sTitle": "Time Limit User", "sClass": "left"},
                            ],
                            "fnDrawCallback": function(oSettings) {
                                ...
                                $("#tableajax tbody tr ").on('mouseenter', 'button', function() {
                                    ...
                                    $.ajax(
                                            {
                                                type: "POST",
                                                url: '<?php echo site_url('ref04/home/get_access') ?>',
                                                dataType: "json",
                                                data: "btn=" + button,
                                                cache: false,
                                                success:
                    ...
                    function reply_click(clicked_id)
                    {
                        ...
                        if (button == 'btn_add') {
                            var content = $("#content");
                            var site = "mod_attendance/index.php/ref04/home/addnew";
                            ...
                            var content = $("#content");
                            var site = "mod_attendance/index.php/ref04/home/edit";
                            ...
                            window.location.href = '<?php echo site_url('ref04/home/excel') ?>';
