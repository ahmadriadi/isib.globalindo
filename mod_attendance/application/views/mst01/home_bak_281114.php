           ...
           function save_job() {
               ...
               // var unitjob = $("#unitjob").val();
                ...
                $.ajax({
                    ...
                    data: "idparent=" + idparent + "&jobloc=" + jobloc + "&jobgrp=" + jobgrp + "&depart=" + depart + "&jobpos=" + jobpos.toUpperCase()+ "&hiredate=" + hiredate + "&datefirst=" + datefirst + "&datestartprob=" + datestartprob +  "&dateprob=" + dateprob + "&contnew=" + contnew + "&contend=" + contend + "&fullname=" + fullname.toUpperCase() +"&nickname=" + nickname.toUpperCase() + "&nobank=" + nobank + "&note=" + note.toUpperCase()+"&status="+status+"&flag="+flag,
                    type: "post",
                    dataType: "json",
                    cache: false,
                    success: function(data) {
