                       ...
                       onClose:function(dateText, inst){ 
                           var hire = $("#hiredate").val(); 
                             $.ajax({
                                    type: "POST",
                                    dataType: "json",
                                    url: "<?php echo site_url('mst01/home/createnip') ?>",
                                    data: "hiredate=" + hire+'&flag='+flag,
           ...
           function save_job() {
               ...
               // var unitjob = $("#unitjob").val();
                ...
                $.ajax({
                    ...
                    data: "idparent=" + idparent + "&jobloc=" + jobloc + "&jobgrp=" + jobgrp + "&depart=" + depart + "&jobpos=" + jobpos.toUpperCase()+ "&hiredate=" + hiredate + "&datefirst=" + datefirst + "&dateprob=" + dateprob + "&contnew=" + contnew + "&contend=" + contend + "&fullname=" + fullname.toUpperCase() +"&nickname=" + nickname.toUpperCase() + "&nobank=" + nobank + "&note=" + note.toUpperCase()+"&status="+status+"&flag="+flag,
                    type: "post",
                    dataType: "json",
                    cache: false,
                    success: function(data) {
