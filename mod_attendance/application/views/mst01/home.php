<html>
	...
	<!-- Upload Foto -->
		...
		loadprovince();
			   ...
			   showjob();	
                           var hire = $("#hiredate").val(); 
			   				   var jobg = $("#jobgrp").val();	
                                      $("#datestartprob").val(hire); 
                             $.ajax({
                                    type: "POST",
                                    dataType: "json",
                                     url: "<?php echo site_url('mst01/home/counternip') ?>",
                                    data: "hiredate=" + hire+'&flag='+flag+'&jobgroup='+jobg,
                                    success: function(data, text) {                                       
                                        $("#idemp").val(data.newnip);
  
					 var paramide = $("#idemp").val();								  
					 $("#browserdata").show();	
						$.ajax({
						    url: ROOT.base_url + "mod_attendance/index.php/mst01/home/get_urlimages/" + paramide,
						    data: "",
						    type: "post",
						    dataType: "json",
						    cache: false,
							...
							$('#imagesdata').attr('src', data.datafoto);
						    }
						}); 
                    ...
                    $("#datestartprob").datepicker({dateFormat: "dd-mm-yy"});
                    $("#dateendprob").datepicker({dateFormat: "dd-mm-yy"}); 	
                    ...
                    $("#datestartprob").keydown(true);
                    $("#dateendprob").keydown(true);	
                   ...
                   // $("#hiredate").datepicker({dateFormat: "dd-mm-yy"}).datepicker('enable');
                    ...
                    $("#datestartprob").datepicker({dateFormat: "dd-mm-yy"}).datepicker('enable');
                    $("#dateendprob").datepicker({dateFormat: "dd-mm-yy"}).datepicker('enable');
                    $("#dateprob").datepicker({dateFormat: "dd-mm-yy"}).datepicker('enable');
...
//                    alert(isinew);
            ...
            function cancel_dup(){
                bootbox.confirm("<center><h3>WARNING!!!</h3></center>By taking this action, the system <b>will delete</b> current duplicated data and bring you to the main of this app menu.\n\
                <br>Press <b>'Back'</b> button instead of 'cancel' if you want to go back and keep duplicated data safe.<br>Continue?",function (r){
                    if (r == true){
                        var idemployee = $("#idemp").val();
                        $.ajax({
                            url     : ROOT.base_url + 'mod_attendance/index.php/mst01/home/cancel_dup',
                            data    : "",
                            type    : "post",
...
//                    alert(tab);
         ...
         /* --------------------START OTHER DATA ---------------------- */  
         $.ajax({
            url: '<?php echo site_url('mst01/home/autocomplete_fakes'); ?>',
            dataType: 'json',
            success: function(d) {
                var data = d;
                $('#fakescode').typeahead({
                    ...
                    updater: function(item) {
                        var s = item.split('-');
                        $('#fakesname').val(s[1]); /* for add item */
         ...
         $.ajax({
            ...
            success: function(d) {
                ...
                $('#fakesname').typeahead({
                    ...
                    updater: function(item) {
                        var s = item.split('-');
                        $('#fakescode').val(s[1]); /* for add item */
                        return s[0]; /* data is array*/
                        return item;
                    },
                    matcher: function(item) {
          ...
          function load_otherdata() {
                ...
                $.ajax({
                    url: ROOT.base_url + "mod_attendance/index.php/mst01/home/get_otherdata/" + idemployee,
                    data: "",
                    type: "post",
                    dataType: "json",
                    cache: false,
                    success: function(data) {
                        $("#fakescode").val(data.FakesCode);
                        $("#fakesname").val(data.FakesName);
                        $("#nppno").val(data.NPPNo);
            ...
            function save_otherdata(){
             ...
             loading();
              $.ajax({
                        url: ROOT.base_url + "mod_attendance/index.php/mst01/home/save_otherdata/" + idemployee,
                        data: "fakescode=" + fakescode + "&nppno=" + nppno.toUpperCase() + "&policeno=" + policeno.toUpperCase() + "&passportno=" + passportno.toUpperCase()+ "&insurancename=" + insurancename.toUpperCase(),
                        type: "post",
                        dataType: "json",
                        cache: false,
                        success: function(data) {
            ...
            function load_exitinterview() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.IDEmployee == null || flag == 'dup') {
                            if (data.IDEmployee == nip){
                                $("#nip").val('');
                            }
                            $("#nip").keydown(true);
                        } else {
		        ...
		        $("input[name='sendmail'][value='N']").prop("checked", true);// for radio       
                        ...
                        $("#tglkeluar").val(checkdate(data.ResignDate));
...
//            job
	     ...
	     function checkdate(datadate){      
	      if(datadate){          
		  return $.datepicker.formatDate('dd-mm-yy', new Date(datadate))
	      }else{
		  return null;
	 ...
	 function showjob(){
                //$("#idemp").removeAttr("disabled", "disabled");
                $("#idparent").removeAttr("disabled", "disabled");
                $("#jobloc").removeAttr("disabled", "disabled");
                $("#depart").removeAttr("disabled", "disabled");
                $("#jobpos").removeAttr("disabled", "disabled");
                $("#hiredate").removeAttr("disabled", "disabled");
                $("#datefirst").removeAttr("disabled", "disabled");
                $("#datestartprob").removeAttr("disabled", "disabled");
                $("#dateendprob").removeAttr("disabled", "disabled");
                $("#dateprob").removeAttr("disabled", "disabled");
                $("#contnew").removeAttr("disabled", "disabled");
                $("#contend").removeAttr("disabled", "disabled");
                $("#fullname").removeAttr("disabled", "disabled");
                $("#nickname").removeAttr("disabled", "disabled");
                $("#nobank").removeAttr("disabled", "disabled");
            ...
            function hidejob(){
                ...
                $("#idemp").attr("disabled", "disabled");
                $("#idparent").attr("disabled", "disabled");
                $("#jobloc").attr("disabled", "disabled");
                $("#depart").attr("disabled", "disabled");
                $("#jobpos").attr("disabled", "disabled");
                $("#hiredate").attr("disabled", "disabled");
                $("#datefirst").attr("disabled", "disabled");
                $("#datestartprob").attr("disabled", "disabled");
                $("#dateendprob").attr("disabled", "disabled");
                $("#dateprob").attr("disabled", "disabled");
                $("#contnew").attr("disabled", "disabled");
                $("#contend").attr("disabled", "disabled");
                $("#fullname").attr("disabled", "disabled");
                $("#nickname").attr("disabled", "disabled");
                $("#nobank").attr("disabled", "disabled");
		    ...
		    $("#idemp").attr("disabled", "disabled");	
		     ...
		     $("#browserdata").show();
		$.ajax({
                    url: ROOT.base_url + "mod_attendance/index.php/mst01/home/get_urlimages/" + idemployee,
                    data: "",
                    type: "post",
                    dataType: "json",
                    cache: false,
                ...
                $.ajax({
                    ...
                    success: function(data) {
                       ...
                       // $("#unitjob").val(data.Unit);			
                        ...
                        $("#hiredate").val(checkdate(data.HireDate));
                        $("#datefirst").val(checkdate(data.DateFirstJoin));
                        $("#datestartprob").val(checkdate(data.DateStartProbation));
                        $("#dateendprob").val(checkdate(data.DateEndProbation));	
                        $("#dateprob").val(checkdate(data.DatePassProbation));
                        $("#contnew").val(checkdate(data.DateNewContract));
                        $("#contend").val(checkdate(data.DateEndContract));        
			$("#fullname").val(data.FullName);
           ...
           function save_job() {
               ...
               // var unitjob = $("#unitjob").val();
                ...
                var datestartprob = $("#datestartprob").val();
                var dateendprob = $("#dateendprob").val(); 	
                ...
                $.ajax({
                    ...
                    data: "idparent=" + idparent + "&jobloc=" + jobloc + "&jobgrp=" + jobgrp + "&depart=" + depart + "&jobpos=" + jobpos.toUpperCase()+ "&hiredate=" + hiredate + "&datefirst=" + datefirst + "&datestartprob=" + datestartprob +"&dateendprob="+dateendprob+  "&dateprob=" + dateprob + "&contnew=" + contnew + "&contend=" + contend + "&fullname=" + fullname.toUpperCase() +"&nickname=" + nickname.toUpperCase() + "&nobank=" + nobank + "&note=" + note.toUpperCase()+"&status="+status+"&flag="+flag+"&empstat="+empstat.toUpperCase(),
                    type: "post",
                    dataType: "json",
                    cache: false,
                    success: function(data) {
		    ...
		    //alert(flag);
                        if(data.status == "failed"){
                             bootbox.alert("Warning - "+data.alertdata, function() {
                                bootbox.hideAll();
                                chgtab("2");
                                $.gritter.add({
                                    title: 'WARNING - Data Failed Saved!',
                                    text: data.alertdata
                                });
                            });
                        }
...
//                    alert($(this).val().toSource());
    ...
    <body>
            ...
            <div class="widget-head">
                <div class="row-fluid">
                    ...
                    <div class="span8" style="text-align:right">
                        <button onclick="reloadpage()" class="btn btn-small btn-default btn-icon glyphicons unshare"><i></i>Back</button>
                        <?php 
                        if ($flag == "dup"){
                        ?>
                        <button onclick="cancel_dup()" class="btn btn-small btn-danger btn-icon glyphicons circle_remove"><i></i>Cancel</button>
                        <?php 
                        }
                        else{
                        ?>
                ...
                <div class="tabsbar tabsbar-2 active-fill">                   
                    ...
                    <ul class="row-fluid ">
                        ...
                        <li class="span1 tab7 tabatas glyphicons certificate">
                         ...
                         <li class="span1 tab9 tabatas glyphicons notes">
                            <a href="#tab9" onclick="chgtab('9')" data-toggle="tab"><i></i> 
                                Other Data                                
                            </a>
                        </li>
                            
                        
                        <?php if ($flag == 'add' or $flag == "dup") { ?>
                    ...
                    <?php if ($flag == 'add' or $flag == "dup") { ?>
                        ...
                        <?php } else { ?>    
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span12" value="-" id="nobpjsemp">
                                        </div>
                                    </div>        
                                </div>
                            </div>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span12" value="-" id="nobpjshlt">
                                        </div>
                                    </div>        
                                </div>
                            </div>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span3">
                                    <div class="control-group">
                                        <label for="noakdhk"><b>Certificate AKHDK No.</b> / <i class="transindo">Nomor Sertifikat AKHDK</i></label>
                                        <div class="controls">
                                            <input type="text" id="noakdhk" class="span12">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row-fluid">
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select id="marrcert" class="span12">
                                ...
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select id="famcert" class="span12">
                                                <option value="0">---</option>
                                                <option value="yes">YES</option>
                                                <option value="no">NO</option>
                                            </select>
                                ...
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span12" value="-" type="text" id="famcertno">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row-fluid">
                                ...
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span12" value="0" type="text" id="couplektp">
                                        </div>
                                    </div>                                    
                                </div>
                            </div>
                            ...
                            <div class="widget widget-body step5">
                                ...
                                function loadprovince(){
                                    $.ajax({
                                        url     : "<?php echo $base_url."mod_attendance/index.php/mst01/home/getallprovince"?>",
                                        data    : "",
                                        type    : "post",
                                        dataType: "json",
                                        cache   : false,
                                ...
                                function loadcities(foraddr,namaprov){
                                    ...
                                    if (namaprov != '-'){
                                        $.ajax({
                                            url     : "<?php echo $base_url."mod_attendance/index.php/mst01/home/get_cities"?>",
                                ...
                                function loadsubs(foraddr,namakota){
                                    ...
                                    if (namakota != '-'){
                                        $.ajax({
                                            url     : "<?php echo $base_url."mod_attendance/index.php/mst01/home/get_subs"?>",
        ...
        //                                        alert(kodekota+","+kodeprov);
                                ...
                                function loadvlgs(foraddr,namakec){
                                    ...
                                    if (namakec != '-'){
                                        $.ajax({
                                            url     : "<?php echo $base_url."mod_attendance/index.php/mst01/home/get_vlgs"?>",
                                            ...
                                            <div class="controls">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <select id="laddrprov" onchange="loadcities('l',this.value)">
                                                            </select>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <select id="laddrcity" onchange="loadsubs('l',this.value)">
                                                            </select>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <select id="laddrsub" onchange="loadvlgs('l',this.value)">
                                                            </select>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            RT :<input type="text" class="span3" id="livert"> RW : <input type="text" class="span3" id="liverw"> 
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td><input type="text" id="lkodepos" maxlength="5" class="span3"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
    ...
    <table>
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <select id="kaddrprov" onchange="loadcities('k',this.value)">
                                                            </select>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <select id="kaddrcity" onchange="loadsubs('k',this.value)">
                                                            </select>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <select id="kaddrsub" onchange="loadvlgs('k',this.value)">
                                                            </select>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            RT :<input type="text" class="span3" id="ktprt">RW : <input type="text" class="span3" id="ktprw"> 
                                                        </td>
                                                    </tr>                                                
                                                    <tr>
                                                        <td colspan="3">
                                                    ...
                                                    <tr>
                                                        <td>Postal Code / <i class="transindo">Kode Pos</i></td>
                                                        <td>:</td>
                                                        <td><input type="text" id="ktpkodepos" maxlength="5" class="span3"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
...
<?php if($flag !=='viewdata'){ ?>                                                <li onclick="savepersonal()"><a class="btn btn-icon btn-primary glyphicons circle_ok"><i></i>Save</a></li> <?php }?>
                                            </ul>
                                        </div>
                                        <!--<button onclick="resetstep(1)" class="btn btn-icon btn-default glyphicons refresh"><i></i>Reset</button>-->
                                        <!--<button onclick="nextstep(2)" class="btn btn-icon btn-primary glyphicons right_arrow"><i></i>Next</button>-->
					   ...
					   <!--===================-->
                         ...
                         <!-- Step 1 -->                        
                        <!-- Start Group -->
                         <div id="browserdata"  style="display:none;">
                            <div class="control-group">
                                <label class="control-label" for="file"></label>                               
                                <div class="controls">                                 
                                       <img height="150" width="150" id="imagesdata" />
                ...
                function ()
                {
                    ...
                    $.ajaxFileUpload
                            (
                                    {
                                        url: '<?php echo site_url('mst01/home/uploaddata') ?>'+'/'+$("#idemp").val(),
                                        secureuri: false,
                                        ...
                                        success: function (data, status)
                                        {
                                            if (typeof (data.error) != 'undefined')
                                            {
                                                if (data.error != '')
                                                {
                                                    alert('upload photo failed :'+data.error);
                                                } else
                                                {

                                                    var valimages = $("#fileToUpload").val();                                                  
                                                    $('#imagesdata').attr('src', '<?php echo $base_url . 'public/fotokaryawan' ?>' + '/' + $("#idemp").val());
                    ...
                    return false;
                        ...
                        <!-- End Group -->
						 ...
						 ---->	
					      <div class="row-fluid">	
                                                <div class="span4">
                                                    <div class="control-group">
                                                        <label for="empstat"><b>Employee Status</b> / <i class='transindo'>Status Karyawan</i></label>
                                                        <div class="controls">
								
	                                                   <!---- <input class="upper span12" id="empstat" type="text"> -->
							  <select class="span12" id="empstat">
						...
						<?php if($flag !=='viewdata'){ ?> 
                                                <button onclick="save_job()" class="btn btn-success btn-icon glyphicons circle_ok"><i></i>Save</button> <?php }?>
                                            </div>
                                            <!--===================-->
                                        </div>
                                        <div class="span4 widget widget-body">
                                            ...
                                            <div class="row-fluid">
                                                <div class="span6">
                                                    <div class="control-group">
                                                        <label for="datestartprob"><b>Start Probation </b> / <i class='transindo'>Tanggal Mulai Masa Percobaan</i></label>
                                                        <div class="controls">
                                                            <input class="span12" id="datestartprob" type="text" >
                                                        </div>
                                                    </div>
                                                </div>
                                                 <div class="span6">
                                                    <div class="control-group">
                                                        <label for="dateendprob"><b>End Probation </b> / <i class='transindo'>Tanggal Berakhir Masa Percobaan</i></label>
                                                        <div class="controls">
                                                            <input class="span12" id="dateendprob" type="text" >
                                                        </div>
                                                    </div>
                                                </div>	
					...
					<?php if($flag !=='viewdata'){ ?>
                                        <button onclick="addfammember()" class="btn btn-primary btn-icon glyphicons circle_plus btnaddfam"><i></i>Add Family Member</button> <?php }?>
                                    </div>
                                </div>
                                <div class="row-fluid">
                                    ...
                                    <div class="widget widget-body addfamily">                            
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12" style="text-align : center;">
                                                <p><?php if($flag !=='viewdata'){ ?> 
                                                    <button onclick="save_family()" class="btn btn-success btn-icon glyphicons circle_ok"><i></i>Save</button> <?php }?>
                            ...
                            <div class="tab-pane" id="tab4">
                                <div class="row-fluid">
                                    ...
                                    <div class="span6" style="text-align: right;">
					<?php if($flag !=='viewdata'){ ?>
                                        <button onclick="addedu()" class="btn btn-primary btn-icon glyphicons circle_plus btnaddedu"><i></i>Add Education Background</button> <?php }?>
                                    </div>
                                </div>
                                <div class="row-fluid">
                                    ...
                                    <div class="widget widget-body addedu">                            
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12" style="text-align : center;">
                                                <p> <?php if($flag !=='viewdata'){ ?>
                                                    <button onclick="save_education()" class="btn btn-success btn-icon glyphicons circle_ok"><i></i>Save</button> <?php }?>
                            ...
                            <div class="tab-pane" id="tab5">
                                <div class="row-fluid">
                                    ...
                                    <div class="span6" style="text-align: right;"> <?php if($flag !=='viewdata'){ ?>
                                        <button onclick="addtnc()" class="btn btn-primary btn-icon glyphicons circle_plus btnaddtnc"><i></i>Add T&amp;C Attended </button><?php }?>
                                    </div>
                                </div>
                                <div class="row-fluid">
                                    ...
                                    <div class="widget widget-body addtnc">                            
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12" style="text-align : center;">
                                                <p><?php if($flag !=='viewdata'){ ?>
                                                    <button onclick="save_tnc()" class="btn btn-success btn-icon glyphicons circle_ok"><i></i>Save</button><?php }?>
                            ...
                            <div class="tab-pane" id="tab6">
                                <div class="row-fluid">
                                    ...
                                    <div class="span6" style="text-align: right;"><?php if($flag !=='viewdata'){ ?>
                                        <button onclick="addlang()" class="btn btn-primary btn-icon glyphicons circle_plus btnaddlang"><i></i>Add Language </button><?php }?>
                                    </div>
                                </div>
                                <div class="row-fluid">
                                    ...
                                    <div class="widget widget-body addlang">                            
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12" style="text-align : center;">
                                                <p><?php if($flag !=='viewdata'){ ?>
                                                    <button onclick="save_lang()" class="btn btn-success btn-icon glyphicons circle_ok"><i></i>Save</button><?php }?>
                            ...
                            <div class="tab-pane" id="tab7">
                                <div class="row-fluid">
                                    ...
                                    <div class="span6" style="text-align: right;"><?php if($flag !=='viewdata'){ ?>
                                        <button onclick="addwork()" class="btn btn-primary btn-icon glyphicons circle_plus btnaddwork"><i></i>Add Working Experience</button><?php }?>
                                    </div>
                                </div>
                                <div class="row-fluid">
                                    ...
                                    <div class="widget widget-body addwork">                            
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12" style="text-align : center;">
                                                <p><?php if($flag !=='viewdata'){ ?>
                                                    <button onclick="save_work()" class="btn btn-success btn-icon glyphicons circle_ok"><i></i>Save</button><?php }?>
					    ...
					    <div class="row-fluid">
                                            ...
                                            <hr class="separator">
                                            <div class="row-fluid">
                                                <div class="span12" style="text-align:center;"><?php if($flag !=='viewdata'){ ?>
                                                    <button onclick="save_exitinterview()" class="btn btn-success btn-icon glyphicons circle_ok"><i></i>Save</button><?php }?>
                                                </div>
                                            </div>
                                            <!--===================-->
                            ...
                            <div class="tab-pane" id="tab9">
                                <h4>Other Data</h4>
                                <div class="widget widget-body otherdata">
                                    <div class="row-fluid">
                                        <div class="span8">
                                            <!--===================-->
                                            <div class="row-fluid">
                                                <div class="span4">
                                                    <div class="control-group">
                                                        <label for="fakescode"><b>Faskes Code</b> / <i class="transindo">Kode Faskes</i></label>
                                                        <div class="controls">
                                                            <input type="text" class="span12" id="fakescode">                                                            
                                                        </div>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="span4">
                                                    <div class="control-group">
                                                        <label for="fakesname"><b>Faskes Name</b> / <i class='transindo'>Nama Faskes</i></label>
                                                        <div class="controls">
                                                            <input type="text" class="span12" id="fakesname">   
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span4">
                                                    <div class="control-group">
                                                        <label for="nppno"><b>NPP No.</b> / <i class='transindo'>Nomor NPP</i></label>
                                                        <div class="controls">
                                                            <input type="text" class="span12" id="nppno">  
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="span4">
                                                    <div class="control-group">
                                                        <label for="policeno"><b>Police No</b> / <i class='transindo'>Nomor Polisi</i></label>
                                                        <div class="controls">
                                                            <input type="text" class="span12" id="policeno">  
                                            ...
                                            <div class="row-fluid">
                                                <div class="span4">
                                                    <div class="control-group">
                                                        <label for="passportno"><b>Passport No</b> / <i class='transindo'>Nomor Passport</i></label>
                                                        <div class="controls">
                                                            <input type="text" class="span12" id="passportno">  
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="span4">
                                                    <div class="control-group">
                                                        <label for="insurancename"><b>Insurance Name</b> / <i class='transindo'>Nama Asuransi</i></label>
                                                        <div class="controls">
                                                            <input type="text" class="span12" id="insurancename">  
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12" style="text-align:center;"><?php if($flag !=='viewdata'){ ?>
                                                    <button onclick="save_otherdata()" class="btn btn-success btn-icon glyphicons circle_ok"><i></i>Save</button><?php }?>
                                                </div>
                                            </div>
                                            <!--===================-->
