                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">                                                 
                            ...
                            <div class="control-group">
                                <label class="control-label" for="f01">Divre Code</label>
                                <div class="controls">
                                    <input class="span7" id="f01" name="f01" type="text"  value="<?php echo set_value('f01', isset($default['f01']) ? $default['f01'] : ''); ?>" 
                            ...
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f02">Regional</label>
                                <div class="controls">
                                    <input class="span7" id="f02" name="f02" type="text"  value="<?php echo set_value('f02', isset($default['f02']) ? $default['f02'] : ''); ?>" 
                            ...
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f03">KC Name</label>
                                <div class="controls">
                            ...
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f04">Dati Name</label>
                                <div class="controls">
                        ...
                        <div class="span6">
                            ...
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f05">Faskes Code</label>
                                <div class="controls">
                                    <input class="span7" id="f05" name="f05" type="text"  value="<?php echo set_value('f05', isset($default['f05']) ? $default['f05'] : ''); ?>" 
                            ...
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f06">Fakes Name</label>
                                <div class="controls">
                                    <input class="span7" id="f06" name="f06" type="text"  value="<?php echo set_value('f06', isset($default['f06']) ? $default['f06'] : ''); ?>" 
                            ...
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f07">Fakes Type</label>
                                <div class="controls">
                                    <input class="span7" id="f07" name="f07" type="text"  value="<?php echo set_value('f07', isset($default['f07']) ? $default['f07'] : ''); ?>" 
                            ...
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f08">Address</label>
                                <div class="controls">
                                    <textarea id="f08" name="f08" cols="18" rows="3" <?php echo (isset($default['readonly_f08'])) ? $default['readonly_f08'] : ''; ?> ><?php echo (isset($default['f08'])) ? $default['f08'] : ''; ?></textarea><span style="color:white;" id="err_f08"></span>                                   
    ...
    $(document).ready(function()
    {
        ...
        save.click(
                function()
                {
                    ...
                    var site = 'mod_attendance/index.php/ref06/home';
                    var url = ROOT.base_url + site;
                    var postdata = "f01=" + f01 + "&f02=" + f02 + "&f03=" + f03 + "&f04=" + f04 + "&f05=" +
                            f05 + "&f06=" + f06 + "&f07=" + f07 + "&f08=" + f08;
