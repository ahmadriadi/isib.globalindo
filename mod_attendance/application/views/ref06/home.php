...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data Fakes</h4>                
            </div>
...
?>
                    ...
                    function reloadpage() {
                        ...
                        var url = ROOT.base_url + 'mod_attendance/index.php/ref06/home/';
                        //alert(url);
                        content.load(url);
                    }
                    function backtohome() {
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('ref06/home/getdatatable') ?>';
                        ...
                        var oTable = $('#tableajax').dataTable({
                            ...
                            "aoColumns": [
                                ...
                                {"mData": "DivreCode", "sTitle": "Divre Code", "sClass": "center"},
                                {"mData": "RegionalName", "sTitle": "Regional", "sClass": "left"},
                                {"mData": "KCName", "sTitle": "KC Name", "sClass": "left"},
                                {"mData": "DatiName2", "sTitle": "Dati Name", "sClass": "left"},
                                {"mData": "FaskesCode", "sTitle": "Code", "sClass": "center"},
                                {"mData": "FakesName", "sTitle": "Name", "sClass": "left"},
                                {"mData": "FakesType", "sTitle": "Type", "sClass": "left"},
                                {"mData": "FakesAddress", "sTitle": "Address", "sClass": "left"},
                            ],
                            "fnDrawCallback": function(oSettings) {
                                ...
                                $("#tableajax tbody tr ").on('mouseenter', 'button', function() {
                                    ...
                                    $.ajax(
                                            {
                                                type: "POST",
                                                url: '<?php echo site_url('ref06/home/get_access') ?>',
                                                dataType: "json",
                                                data: "btn=" + button,
                                                cache: false,
                                                success:
                    ...
                    function reply_click(clicked_id)
                    {
                        ...
                        if (button == 'btn_add') {
                            var content = $("#content");
                            var site = "mod_attendance/index.php/ref06/home/addnew";
                            ...
                            var content = $("#content");
                            var site = "mod_attendance/index.php/ref06/home/edit";
                                    ...
                                    $("#dialog-confirm").dialog({
                                        ...
                                        buttons: {
                                            "Delete ": function() {
                                                $.ajax({
                                                    type: "POST",
                                                    url: '<?php echo site_url('ref06/home/delete') ?>' + '/' + id,
                                                    dataType: "json",
                                                    cache: false,
                                                    success:
                                                            function(data) {
                            ...
                            window.location.href = '<?php echo site_url('ref06/home/excel') ?>';
