...
<script>
	...
	/*
        var url_suggest = '<?php echo site_url('rpt05/home/suggest_employee'); ?>';
        $("#f03").autocomplete({
            minLength: 2,
	...
	*/
	 ...
	 $.ajax({
	    url: '<?php echo site_url('rpt05/home/autocomplete_employee'); ?>',
	    dataType: 'json',
	    success: function(d) {
		var data = d;
		$('#f03').typeahead({
        ...
        process.click(function() {
            var url_presence = '<?php echo site_url('rpt05/home/presencedata') ?>';
            var fromdate = $("#f01").val();
            var untildate = $("#f02").val();
            var nip = $("#f03").val();
            var content = $("#content .innerLR");
            var site = 'mod_attendance/index.php/rpt05/home/iframedata/' +fromdate+'/'+ untildate + '/' + nip;
