...
<div class="box-generic">
    ...
    <div class="tabsbar">
        <ul>
            <li class="glyphicons restart active"><a href="#presence" data-toggle="tab"><i></i>MOVING DATE PROCESS<strong></strong></a></li>
        </ul>
    </div>
    <!-- // Tabs Heading END -->
            ...
            <div class="widget">               
                <div class="widget-body">
                    <div class="control-group">
                        <label class="control-label" for="f01">Tanggal di liburkan</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="f02">Tanggal Pengganti</label>
                        <div class="controls">
 ...
 <?php 
    ...
    $(document).ready(function() {
        ...
        process.click(function() {
            var url_posting = '<?php echo site_url('proc02/home/movingpresence') ?>';
