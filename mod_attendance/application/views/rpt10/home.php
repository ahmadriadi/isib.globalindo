...
<div class="box-generic">
    ...
    <div class="tabsbar">
        <ul>
            <li class="glyphicons tag active"><a href="#presencejurnal" data-toggle="tab"><i></i>REPORT INCOMPLETE PRESENCE<strong></strong></a></li>
        </ul>
...
<script>
	...
	/*
        var url_suggest = '<?php echo site_url('rpt10/home/suggest_employee'); ?>';
        $("#f03").autocomplete({
            minLength: 2,
	...
	*/
	 ...
	 $.ajax({
	    url: '<?php echo site_url('rpt10/home/autocomplete_employee'); ?>',
	    dataType: 'json',
	    success: function(d) {
		var data = d;
		$('#f03').typeahead({
        ...
        process.click(function() {
            var url_presence = '<?php echo site_url('rpt10/home/presencedata') ?>';
            var fromdate = $("#f01").val();
            var untildate = $("#f02").val();
            var nip = $("#f03").val();
            var group = $('input:radio[name=f04]:checked').val();
            var content = $("#content .innerLR");
            var site = 'mod_attendance/index.php/rpt10/home/iframedata/' + group + '/' + fromdate + '/' + untildate + '/' + nip;
