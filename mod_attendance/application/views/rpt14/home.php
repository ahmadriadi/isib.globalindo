...
<div class="box-generic">
    ...
    <div class="tabsbar">
        <ul>
            <li class="glyphicons tag active"><a href="#presencejurnal" data-toggle="tab"><i></i>REPORT SUMMARY ABSENCE STAFF<strong></strong></a></li>
        </ul>
    </div>
    <!-- // Tabs Heading END -->
...
<script>
	...
	/*
        var url_suggest = '<?php echo site_url('rpt14/home/suggest_employee'); ?>';
        $("#f03").autocomplete({
            minLength: 2,
	...
	*/
	 ...
	 $.ajax({
	    url: '<?php echo site_url('rpt14/home/autocomplete_employee'); ?>',
	    dataType: 'json',
	    success: function(d) {
		var data = d;
		$('#f03').typeahead({
        ...
        process.click(function() {
            var url_presence = '<?php echo site_url('rpt14/home/presencedata') ?>';
            var fromdate = $("#f01").val();
            var untildate = $("#f02").val();
            var nip = $("#f03").val();
            var content = $("#content .innerLR");
            var site = 'mod_attendance/index.php/rpt14/home/iframedata/' +'ST'+'/'+ fromdate + '/' + untildate+'/'+nip;
