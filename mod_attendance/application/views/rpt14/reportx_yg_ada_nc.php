    ...
    <body bgcolor="#FFFFFF">
		...
		.red{ background-color:#E9967A;}
            ...
            <table style="page-break-after:always; ">
                ...
                <tr>
                    <th width="10px" rowspan="3" >ID</th>
                    <th width="100px" rowspan="3" >IDEMPLOYEE</th>
                    <th width="200px" rowspan="3" >FULLNAME</th>                    
                    <th width="100px"  colspan="8" >TYPE ABSENCE</th>
                </tr>
                <tr width="100%">
                    <th align="center" colspan="2">A</th>
                    <th align="center" rowspan="2">SP</th>  	
                    <th align="center" rowspan="2">OL</th>
                    <th align="center" rowspan="2">SN</th>
                    <th align="center" rowspan="2">ALD</th>
                </tr>                
                <tr width="100%">
                ...
                function cetak_summary($unit,$counter, $LastIDEmployee, $LastFullName, $A_Count,$NC_Count,   $SP_Count, $OL_Count, $SN_Count, $ALD_Count) {
                    if($unit=='SECURITY'){
                        ...
                        $html.= "   <td align='right'>" . $NC_Count . "</td>";
		...
		$lastemp_unit = '';
				...
				$description !== 'SP' &&
                        ...
                        if ($row['IDEmployee'] !== $lastemp_idemployee && $n > 0) {
                            $counter++;
                            cetak_summary($lastemp_unit,$counter, $lastemp_idemployee, $lastemp_fullname, $A_Count,$NC_Count, $SP_Count, $OL_Count, $SN_Count, $ALD_Count);
                            $A_Count =$NC_Count= $SP_Count = $OL_Count = $SN_Count = $ALD_Count = 0;
                        }
                        $n++;
			...
			$ain = $row['ActualIn'];
                        ...
                        if ($description == 'A') {
                            ...
                            $SP_Count+= 1;
                            $data['SP'] = 1;
                        } elseif ($description == 'OL') {
                            $OL_Count+= 1;
                            $data['OL'] = 1;
                        } elseif ($description == 'SN') {
                            $SN_Count+= 1;
                            $data['SN'] = 1;
			...
			$lastemp_unit = $row['IDUnitGroup'];
				...
				<tr>                    
                                    <td align="left" nowrap="nowrap" style="font-size:xx-small" width="50px">NC</td>
                                    <td style="font-size:xx-small">: Not Complete (Absensi Tidak Lengkap)</td>
                                </tr>
                                <tr>                    
