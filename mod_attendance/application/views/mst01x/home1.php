...
//                $("#empstat").keydown(false);
                ...
                if (flag == 'add') {
                    ...
                    chgtab(1);
                    $("#hiredate").datepicker({dateFormat: "dd-mm-yy"}).datepicker('disable');
                    $("#datefirst").datepicker({dateFormat: "dd-mm-yy"}).datepicker('disable');
                    $("#dateprob").datepicker({dateFormat: "dd-mm-yy"}).datepicker('disable');
                    $("#contnew").datepicker({dateFormat: "dd-mm-yy"}).datepicker('disable');
                    $("#contend").datepicker({dateFormat: "dd-mm-yy"}).datepicker('disable');
