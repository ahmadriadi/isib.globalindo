    ...
    <body>
        <div class="colmask fullpage"> 
           ...
           <BR />
                ...
                <p>
                    We are pleased to announce the following new employee : <BR />
                </p>
		    ...
		    <tr>
                    ...
                    <tr>
                        <td>-</td><td>Effective date</td><td>:</td><td><?php echo date('d-m-Y',  strtotime($hire)); ?></td>
                    </tr>                   
                </table>
                        <BR />
                <p>
                    Please join us in welcoming him/her to PT. Trias Indra Saputra and<br/>
wishing him/her all the best in his/her assignment.
                </p>
                 <p>
                    Regards,<BR /><BR />
                </p>
