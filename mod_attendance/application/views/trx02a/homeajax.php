...
?>
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('trx02a/home/dataleavepermit') ?>';
			    ...
			    "sPaginationType2": "bootstrap",
                            ...
                            "aoColumns": [
                                ...
                                {"mData": "LeavePermitDate", "sTitle": "LeavePermit Date", "sClass": "left", sType: 'date-eu'},
                                {"mData": "OutDate", "sTitle": "Out from Office", "sClass": "left", sType: 'date-eu'},
                                {"mData": "InDate", "sTitle": "In to Office", "sClass": "left", sType: 'date-eu'},
                                {"mData": "IMKHour", "sTitle": "IMK Hour", "sType": "formatted-num", "sClass": "right"},
                            ...
                            "fnDrawCallback": function(oSettings) {
                                $("#tableajax tbody tr ").on('click', 'button', function() {
                                    ...
                                    $.ajax(
                                            {
                                                type: "POST",
                                                url: '<?php echo site_url('trx02a/home/getstatus') ?>',
                                                dataType: "json",
                                                data: "id=" + id,
                                                cache: false,
                                                success:
                                ...
                                $("#tableajax tbody tr ").on('mouseenter', 'button', function() {
                                    ...
                                    $.ajax(
                                            {
                                                type: "POST",
                                                url: '<?php echo site_url('trx02a/home/get_access') ?>',
                                                dataType: "json",
                                                data: "btn=" + button,
                                                cache: false,
                                                success:
			...
			var group = $("#group").val();
                        ...
                        if (button == 'btn_add') {
                            ...
                            if ((status == '0' || status == '1') && inputby == 'emp' && access == 'false') {
                                $.gritter.add({
                                    title: 'WARNING',
                                    text: "You can't edit the data " + fullname,
                            ...
                            if (status == '0' || status == '1' && inputby == 'emp' && access == 'false') {
                                $.gritter.add({
                                    title: 'WARNING',
                                    text: "You can't delete the data " + fullname,
                                    image: '<?php echo $base_url . 'public/theme/images/warni.jpeg' ?>',
                                    class_name: 'gritter-light',
                                    fade_in_speed: 100,
                                    fade_out_speed: 100,
                            ...
                            window.location.href = '<?php echo site_url('trx02a/home/excel') ?>'+'/'+group;
