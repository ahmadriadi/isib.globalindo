...
<br>
    ...
    <br><br>
    <p>
        You have 1 overtime submission awaiting your confirmation from Mr./Mrs./Ms. <b><?php echo $sendername;?></b>.
    </p>
    <p>
...
<br>
    ...
    <br><br>
    <p>
        Your submitted overtime (IDSPKL : <b><?php echo $overtime->IDSPKL." | #".$overtime->ID;?></b>) has been accepted by the head of your department.
    </p>
    <p>
        Please, open your Employee Center at this <a href='http://192.168.0.5/office'><b>local</b></a> or <a href="http://119.110.75.218/office"><b>public</b></a> address! <br>
        Thank you    
...
<br>
    ...
    <br><br>
    <p>
        Your submitted overtime (IDSPKL : <b><?php echo $overtime->IDSPKL." | #".$overtime->ID;?></b>) rejected by the head of your department. Please, see the reason of this rejection.
    </p>
    <p>
