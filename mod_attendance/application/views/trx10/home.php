...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data Permission to Leave Work</h4>                
            </div>
    ...
    <script type="text/javascript">
                    ...
                    function reloadpage() {
                        ...
                        var url = ROOT.base_url + 'mod_attendance/index.php/trx10/home/';
                        //alert(url);
                        content.load(url);
                    }
                    function backtohome() {
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('trx10/home/dataleavework') ?>';
                        ...
                        var oTable = $('#tableajax').dataTable({
                            ...
                            "aoColumns": [
                                ...
                                {"mData": "StartDate", "sTitle": "Start On Date", "sClass": "left", sType: 'date-eu'},
                                {"mData": "FinishDate", "sTitle": "Finish On Date", "sClass": "left", sType: 'date-eu'},
                                {"mData": "OnDay", "sTitle": "On Day", "sClass": "left"},
                                {"mData": "LeaveHour", "sTitle": "Leave Hour", "sClass": "left"},
                            ...
                            "fnDrawCallback": function(oSettings) {
                                ...
                                $("#tableajax tbody tr").on('mouseenter', function() {
                                 ...
                                 $("#tableajax tbody tr ").on('mouseenter','button', function() {                                   
                                     ...
                                     {
                                        type: "POST",
                                        url: '<?php echo site_url('trx10/home/get_access') ?>',
                                        dataType: "json",
                                        data: "btn=" + button,
                                        cache: false,
                                        success:
                        ...
                        var url_periode = '<?php echo site_url('trx10/home/set_pattern_date') ?>';
                        var content = $("#content");
			...
			var group = $("#group").val();
                        ...
                        if (button == 'btn_add') {
                            var content = $("#content");
                            var site = "mod_attendance/index.php/trx10/home/addnew";
                            var url = ROOT.base_url + site;
                            content.load(url);
                        } else if (button == 'btn_edit') {
                            var content = $("#content");
                            var site = "mod_attendance/index.php/trx10/home/edit";
                                    ...
                                    $("#dialog-confirm").dialog({
                                        ...
                                        buttons: {
                                            "Delete ": function() {
                                                $.ajax({
                                                    type: "POST",
                                                    url: '<?php echo site_url('trx10/home/delete') ?>' + '/' + id,
                                                    dataType: "json",
                                                    cache: false,
                                                    success:
                                                            function(data) {
                            ...
                            window.location.href = '<?php echo site_url('trx10/home/exportdata') ?>'+'/'+group;
