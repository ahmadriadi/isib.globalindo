...
<div class="box-generic">
    ...
    <div class="tabsbar">
        <ul>
            <li class="glyphicons tag active"><a href="#presencejurnal" data-toggle="tab"><i></i>REPORT OFFICIAL TRAVEL<strong></strong></a></li>
        </ul>
    </div>
    <!-- // Tabs Heading END -->
...
<script>
	...
	/*
        var url_suggest = '<?php echo site_url('rpt06/home/suggest_employee'); ?>';
        $("#f03").autocomplete({
            minLength: 2,
	...
	*/
	...
	$.ajax({
	    url: '<?php echo site_url('rpt06/home/autocomplete_employee'); ?>',
	    dataType: 'json',
	    success: function(d) {
		var data = d;
		$('#f03').typeahead({
        ...
        process.click(function() {
            var url_presence = '<?php echo site_url('rpt06/home/presencedata') ?>';
            var fromdate = $("#f01").val();
            var untildate = $("#f02").val();
            var nip = $("#f03").val();
            var content = $("#content .innerLR");
            var site = 'mod_attendance/index.php/rpt06/home/iframedata/' +fromdate+'/'+ untildate + '/' + nip;
            var url = ROOT.base_url + site;
            
            var url_post = url_presence+'/'+fromdate+'/'+untildate+'/'+nip;
