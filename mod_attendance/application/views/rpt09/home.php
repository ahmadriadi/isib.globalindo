...
<div class="box-generic">
    ...
    <div class="tabsbar">
        <ul>
            <li class="glyphicons tag active"><a href="#presencejurnal" data-toggle="tab"><i></i>REPORT ABSENCE EMPLOYEE<strong></strong></a></li>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <?php echo (isset($default['readonly_f03'])) ? $default['readonly_f03'] : ''; ?>
                                           /><i>*)Fill it blank to print the data of a group of employees </i> 
...
<script>
    ...
    $(document).ready(function() {
	   ...
	   $.ajax({
	    url: '<?php echo site_url('rpt09/home/autocomplete_employee'); ?>',
	    dataType: 'json',
	    success: function(d) {
		var data = d;
		$('#f03').typeahead({
	...
	/*
        var url_suggest = '<?php echo site_url('rpt09/home/suggest_employee'); ?>';
        $("#f03").autocomplete({
            minLength: 2,
	...
	*/
        ...
        process.click(function() {
            var url_presence = '<?php echo site_url('rpt09/home/presencedata') ?>';
            var fromdate = $("#f01").val();
            var untildate = $("#f02").val();
            var nip = $("#f03").val();
            var group = $('input:radio[name=f04]:checked').val();
            var content = $("#content .innerLR");
            var site = 'mod_attendance/index.php/rpt09/home/iframedata/' + group + '/' + fromdate + '/' + untildate + '/' + nip;
