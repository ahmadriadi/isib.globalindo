...
<br>
<br>
    Dear <b><?php echo $pre.$receivername;?></b>,
    <br><br>
    <p>
        You have 1 incomplete-presence submission awaiting your confirmation from Mr./Mrs./Ms. <b><?php echo $sendername;?></b>.
    </p>
    <p>
...
if ($state == "status" and $confirm == "1"){
    if ($notfor == 'man'){
        $siapa  = 'the head of your department';
    }
    if ($notfor == 'hrd'){
        $siapa  = 'the human resource development';
    }    
    ?>
<text>
<span style="font-size: 13px;">
...
<br>
    ...
    <br><br>
    <p>
        Your submitted incomplete-presence (dated : <b><?php echo $incomp->IncompleteDate." | #".$incomp->ID;?></b>) has been accepted by <?php echo $siapa;?>.
    </p>
    <p>
        Please, open your Employee Center at this <a href='http://192.168.0.5/office'><b>local</b></a> or <a href="http://119.110.75.218/office"><b>public</b></a> address! <br>
        Thank you    
...
<br>
    ...
    <br><br>
    <p>
        Your submitted incomplete-presence (dated : <b><?php echo $incomp->IncompleteDate." | #".$incomp->ID;?></b>) rejected by <?php echo $siapa?>. Please, see the reason of this rejection.
    </p>
    <p>
