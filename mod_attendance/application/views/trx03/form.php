...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        var flagcondition = '<?php echo $flagcondition; ?>';
        ...
        function showDays() {
            ...
            $.ajax({
                ...
                dataType: "json",
                data: "f03=" + f03,
                url: "<?php echo site_url('trx03/home/getrange_date') ?>",
                success: function(data, text) {
                    if (data.valid == 'true') {


                        if (data.sumday > '2' && flagcondition == 'add') {
                            $("#f04").attr("disabled", "disabled");
                            $("#f05").attr("disabled", "disabled");
                            $("#f06").attr("disabled", "disabled");

                            $.gritter.add({
                                title: 'WARNING ',
                                text: 'Your request incomplete presence has more than 1 x 24 hour',
                            ...
                            $("#f04").removeAttr("disabled", "disabled");
                            $("#f05").removeAttr("disabled", "disabled");
                            $("#f06").removeAttr("disabled", "disabled");
                        }
