...
<div class="box-generic">
    ...
    <div class="tabsbar">
        <ul>
            <li class="glyphicons tag active"><a href="#presencejurnal" data-toggle="tab"><i></i>REPORT OVERTIME<strong></strong></a></li>
...
<script>
	...
	/*
        var url_suggest = '<?php echo site_url('rpt04/home/suggest_employee'); ?>';
        $("#f03").autocomplete({
            minLength: 2,
	...
	*/
	...
	$.ajax({
	    url: '<?php echo site_url('rpt04/home/autocomplete_employee'); ?>',
	    dataType: 'json',
	    success: function(d) {
		var data = d;
		$('#f03').typeahead({
        ...
        process.click(function() {
            var url_overtime = '<?php echo site_url('rpt04/home/overtimedata') ?>';
            var fromdate = $("#f01").val();
            var untildate = $("#f02").val();
            var name = $("#f03").val();
            var group = $('input:radio[name=f04]:checked').val();
            var content = $("#content .innerLR");
            var site = 'mod_attendance/index.php/rpt04/home/iframedata/' + group + '/' + fromdate + '/' + untildate + '/' + name;
            var url = ROOT.base_url + site;

            var postdata = url_overtime + '/' + group + '/' + fromdate + '/' + untildate + '/' + name;
