        ...
        <form class="form-horizontal" style="margin-bottom: 0;" id="validateSubmitForm" method="get" autocomplete="off">
            ...
            <div class="widget"
                 ...
                 <div class="widget-head">
                    <h4 class="heading">Employee Picket</h4>
                </div>
                <!-- // Widget heading END -->
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            ...
                            <!-- Group end -->                            
                               <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f03">Range Picket</label>
                                <div class="controls">
                                    <?php
                                                $no = 'A';
                            ...
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f04">From Date</label>
                                <div class="controls">
                            ...
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f05">Until Date</label>
                                <div class="controls">
                        ...
                        <div class="span6">                           
                               ...
                               <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f06">Status Picket</label>
                                <div class="controls">
                                    <?php
                                                $no = 'A';
...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
	 ...
	 $.ajax({
	    url: '<?php echo site_url('trx12/home/autocomplete_employee'); ?>',
	    dataType: 'json',
	    success: function(d) {
		var data = d;
		$('#f02').typeahead({
        ...
        $('#f07').focusout(function() {
            var f07 = $("#f07").val();
            $("#f07").val(f07.toUpperCase());
        });
        ...
        save.click(
                function()
                {
                    ...
                    var postdata = "id="+id+"&f01=" + f01 + "&f02=" + f02 + "&f03=" + f03 + "&f04=" + f04 +
