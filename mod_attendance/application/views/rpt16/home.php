...
<div class="box-generic">
    ...
    <div class="tabsbar">
        <ul>
            <li class="glyphicons tag active"><a href="#presencejurnal" data-toggle="tab"><i></i>REPORT SUMMARY OVERTIME FIELD<strong></strong></a></li>
...
<script>
    ...
    $(document).ready(function() {
	 ...
	 $.ajax({
	    url: '<?php echo site_url('rpt16/home/autocomplete_employee'); ?>',
	    dataType: 'json',
	    success: function(d) {
		var data = d;
		$('#f03').typeahead({
	...
	/*
        var url_suggest = '<?php echo site_url('rpt16/home/suggest_employee'); ?>';
        $("#f03").autocomplete({
            minLength: 2,
	...
	*/
        ...
        process.click(function() {
            var url_overtime = '<?php echo site_url('rpt16/home/overtimedata') ?>';
            var fromdate = $("#f01").val();
            var untildate = $("#f02").val();
            var nip = $("#f03").val();
            var group = $('input:radio[name=f04]:checked').val();
            var content = $("#content .innerLR");
            var site = 'mod_attendance/index.php/rpt16/home/iframedata/' + group + '/' + fromdate + '/' + untildate + '/' + nip;
            var url = ROOT.base_url + site;

            var url_post = url_overtime + '/' + group + '/' + fromdate + '/' + untildate + '/' + nip
