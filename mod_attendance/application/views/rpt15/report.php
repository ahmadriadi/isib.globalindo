		...
		.red{ background-color:#E9967A;}
            ...
            <table style="page-break-after:always; ">
                ...
                <tr width="100%">
                    ...
                    <th align="center" width="20px">RTC</th>
                </tr>
                </thead>
                <!-- Dinamis -->
                ...
                function cetak_summary($unit,$counter, $LastIDEmployee, $LastFullName, $A_Count, $SP_Count, $OL_Count, $SN_Count, $ALD_Count,$RTC_Count) {
                    if($unit=='SECURITY'){
                        ...
                        $html.= "   <td align='right'>" . $RTC_Count . "</td>";
                        $html.= "</tr> ";
                    }else{                        
                ...
                $A_Count = $SP_Count = $OL_Count = $SN_Count = $ALD_Count = $RTC_Count = 0;
                $counter = 0;
                $lastemp_idemployee = '';
                $lastemp_fullname = '';
		$lastemp_unit = '';
				...
				$description !== 'SP' &&
                        ...
                        if ($row['IDEmployee'] !== $lastemp_idemployee && $n > 0) {
                            $counter++;
                            cetak_summary($lastemp_unit,$counter, $lastemp_idemployee, $lastemp_fullname, $A_Count, $SP_Count, $OL_Count, $SN_Count, $ALD_Count,$RTC_Count);
                            $A_Count = $SP_Count = $OL_Count = $SN_Count = $ALD_Count =  $RTC_Count =0;
                        }
                        $n++;
			...
			$min = $row['ManualIn'];
                       ...
                       // echo $row['IDEmployee'].' - '.$row['PresenceDate'].'<br/>';
                        ...
                        if ($description == 'A') {
                             if ((!is_null($resign) AND ($presence >= $resign))) {
                                $RTC_Count+= 1;
                             }else{
                                 $A_Count+= 1;
                                 $data['A'] = 1;
			...
			$lastemp_unit = $row['IDUnitGroup'];
                ...
                <tr width="100%" class="subfoot">
                    ...
                    <td align="right"><?php echo $RTC_Count; ?></td>
                    ...
                    <tr>
                        <td colspan="42">
                            <table width="100%">
                                ...
                                <tr>                    
                                    <td align="left" nowrap="nowrap" style="font-size:xx-small">RTC</td>
                                    <td style="font-size:xx-small">: Resign to Cut Off (Potong karena Resign)</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
