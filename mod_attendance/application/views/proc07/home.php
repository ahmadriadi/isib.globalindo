...
<div class="box-generic">
    ...
    <div class="tabsbar">
        <ul>
            <li class="glyphicons restart active"><a href="#presence" data-toggle="tab"><i></i>RECOVERY PRESENCE PROCESS<strong></strong></a></li>
        </ul>
    </div>
    <!-- // Tabs Heading END -->
            ...
            <div class="widget">               
                <div class="widget-body">
                    <div class="control-group">
                        <label class="control-label" for="f01">Error Date</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="f02">Recovery Date</label>
                        <div class="controls">
...
<script>
 <?php 
    ...
    $(document).ready(function() {
	    ...
	    var url_posting = '<?php echo site_url('proc07/home/postingpresence') ?>'+"/"+fromdate+"/"+untildate;
