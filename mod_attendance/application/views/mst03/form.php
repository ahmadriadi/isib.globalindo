...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        var cancel = $('#btn_cancel');
          ...
          var url_autocomplete = '<?php echo site_url('mst03/home/autocomplete_employee'); ?>';
                ...
                $('#f02').typeahead({
                    source: function(query, process) {
                        ...
                        $.each(data, function(i, object) {                                                   
                            objects.push(object.idemployee + '-' 
                                         + object.fullname+ '-' 
                                         + object.enroll+ '-' 
                                         + object.nocard+ '-' 
                                         + object.location                               
                    ...
                    updater: function(item) {
                        var s = item.split('-');
                        $('#f01').val(s[2]); /* for add item */
                        $('#f03').val(s[3]); /* for add item */

                        var lokasi = s[4];
                        
                        if(lokasi=='1'){
                             $("input[name='f04'][value='Kapuk']").prop("checked", true);// for radio 
                        }else if(lokasi=='2'){
                             $("input[name='f04'][value='Bitung']").prop("checked", true);// for radio 
                        }
