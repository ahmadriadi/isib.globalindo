...
<div class="box-generic">
    ...
    <div class="tabsbar">
        <ul>
            <li class="glyphicons restart active"><a href="#presence" data-toggle="tab"><i></i>UPDATE PRESENCE<strong></strong></a></li>
        </ul>
    </div>
    <!-- // Tabs Heading END -->
...
<script>
   <?php 
    ...
    $(document).ready(function() {
	    ...
	    var url_posting = '<?php echo site_url('proc04/home/postingpresence') ?>'+"/"+fromdate+"/"+untildate;
