...
<div class="box-generic">
    ...
    <div class="tabsbar">
        <ul>
            <li class="glyphicons tag active"><a href="#presencejurnal" data-toggle="tab"><i></i>ACTUAL PRESENCE<strong></strong></a></li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            ...
                            <!-- Group end -->  
                              <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f05">Display</label>
                                <div class="controls">
                                    <?php
                                    $no = 'A';
...
<script>
    ...
    $(document).ready(function() {
        ...
        process.click(function() {
            var url_presence = '<?php echo site_url('rpt21/home/presencedata') ?>';
            var fromdate = $("#f01").val();
            var untildate = $("#f02").val();
            var group = $('input:radio[name=f04]:checked').val();
            var type = $('input:radio[name=f05]:checked').val();
            var content = $("#content .innerLR");
            var site = 'mod_attendance/index.php/rpt21/home/iframedata/' + group + '/'+ type + '/'  + fromdate + '/' + untildate;
            var url = ROOT.base_url + site;

            var url_post = url_presence + '/' + group + '/' + type + '/' +  fromdate + '/' + untildate
