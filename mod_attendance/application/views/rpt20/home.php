...
<div class="box-generic">
    ...
    <div class="tabsbar">
        <ul>
            <li class="glyphicons tag active"><a href="#presencejurnal" data-toggle="tab"><i></i>REPORT UNPAID LEAVE<strong></strong></a></li>
...
<script>
	...
	/*
        var url_suggest = '<?php echo site_url('rpt20/home/suggest_employee'); ?>';
        $("#f03").autocomplete({
            minLength: 2,
	...
	*/
	 ...
	 $.ajax({
	    url: '<?php echo site_url('rpt20/home/autocomplete_employee'); ?>',
	    dataType: 'json',
	    success: function(d) {
		var data = d;
		$('#f03').typeahead({
        ...
        process.click(function() {
            var url_presence = '<?php echo site_url('rpt20/home/presencedata') ?>';
            var fromdate = $("#f01").val();
            var untildate = $("#f02").val();
            var nip = $("#f03").val();         
            var content = $("#content .innerLR");
            var site = 'mod_attendance/index.php/rpt20/home/iframedata/' + fromdate + '/' + untildate + '/' + nip;
