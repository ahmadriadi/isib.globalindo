...
function accept(){
    ...
    if (jmlbox == 1){
        if (submitted[0] == val){
            $.ajax({
                url     : ROOT.base_url+'/mod_attendance/index.php/trx01a/home/confirm',
                data    : "idovertime=<?php echo $idovertime;?>&stat=1",// rencana ada via web dan email. yang lain di sini via=web
                type    : "post",
        ...
        if (submitted[0] == val){
            bootbox.prompttextarea("You are going to reject this Leave Permit request.</isi>Please write your reason here :", function (r){
                if (r === null){
                    ...
                    $.ajax({
                        url     : ROOT.base_url+'/mod_attendance/index.php/trx01a/home/confirm',
                        data    : "idovertime=<?php echo $idovertime;?>&stat=2&reason="+r,
                        type    : "post",
//                        dataType: "html",
                        success : function (data){
    //                        bootbox.alert(data);
