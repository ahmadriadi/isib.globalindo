        ...
        <div align="center">
            ...
            <table style="width:100% ;table-layout:fixed"  border="0" cellpadding="0" cellspacing="0" class="warna">
                ...
                <tr>
                    ...
                    <td class="warna" colspan="2" valign="top" align='center'><?php echo $departement; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="warna" colspan="3" rowspan="2" valign="bottom" align='center'><div align="center"><?php echo $dateadd ?><br/><?php echo $name ?></td>
                    <td class="warna" height="128px" valign="bottom" align='center'><div align="center"><?php echo $dateconfirm ?><br/><?php echo $parent ?></td>
                    <td class="warna" colspan="2" valign="bottom" align='center'><div align="center"><?php echo $namehrdmgr ?></td>
                </tr>
                <tr>
