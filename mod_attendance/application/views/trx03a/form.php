...
<script type="text/javascript">
	...
	/*
        var url_suggest = '<?php echo site_url('trx03a/home/suggest_employee'); ?>';
        $("#f02").autocomplete({
            minLength: 2,
	...
	*/
	...
	$.ajax({
	    url: '<?php echo site_url('trx03a/home/autocomplete_employee'); ?>',
	    dataType: 'json',
	    success: function(d) {
		var data = d;
		$('#f02').typeahead({
        ...
        $('#f02').focusout(function() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "<?php echo site_url('trx03a/home/atluser') ?>",
                data: "idemployee=" + nip,
        ...
        save.click(
                function()
                {
                    ...
                    if (enddatatal !== '0') {
                        bootbox.confirm("Are you sure save data " + f02 + " with incomplete has been " + enddatatal + " on this periode ?", function(result) {
