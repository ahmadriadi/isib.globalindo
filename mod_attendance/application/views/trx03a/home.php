        ...
        <div class="btn-group">
		    ...
		    <td>
                       <div class="row-fluid">
                        ...
                        <select class=" selectpicker span16" data-style="btn-inverse" id="group" name="group" >
...
?>
                    ...
                    function reloadpage() {
                        var content = $("#content");
                        var url = ROOT.base_url + 'mod_attendance/index.php/trx03a/home/';
                        //alert(url);
                        content.load(url);
                    }
                    function backtohome() {
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('trx03a/home/dataincomplete') ?>';
			    ...
			    "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                              var nip=aData.IDEmployee;
                              var incompletedate =aData.IncompleteDate; 
                                
                                        $.ajax({
                                        type: "POST",
                                        dataType: "json",
                                        url: "<?php echo site_url('trx03a/home/checkatal') ?>",
                                        data: "idemployee=" + nip+"&incompletedate="+incompletedate,
                                        success: function(data, text) { 
                                                             
                                                           if(data.infoatl=='warning'){
                                                               $('td', nRow).addClass('atl'); 
                            ...
                            "fnDrawCallback": function(oSettings) {
                                $("#tableajax tbody tr ").on('click', 'button', function() {
                                    ...
                                    $.ajax(
                                            {
                                                type: "POST",
                                                url: '<?php echo site_url('trx03a/home/getstatus') ?>',
                                                dataType: "json",
                                                data: "id=" + id,
                                                cache: false,
                                                success:
                                                        function(data, text)
                                                        {
                                                            if (data.valid == 'true') {
                                                                ...
                                                                var inputdata = data.inputby;
                                                                var name = data.name;
                                                                var btnaccess = data.accessbtn;
                                                                reply_click(button + '-' + id + '-' + status + '-' + inputdata + '-' + name + '-' + btnaccess);
                                                            }
                                                            else {
                                                            }
                                ...
                                $("#tableajax tbody tr ").on('mouseenter', 'button', function() {
                                    ...
                                    $.ajax(
                                            {
                                                type: "POST",
                                                url: '<?php echo site_url('trx03a/home/get_access') ?>',
                                                dataType: "json",
                                                data: "btn=" + button,
                                                cache: false,
                                                success:
                        ...
                        var url_periode = '<?php echo site_url('trx03a/home/set_pattern_date') ?>';
                        var content = $("#content");
                        var site = "mod_attendance/index.php/trx03a/home";
			 ...
			 $('select#group').on('change',function(){
		        ...
		        var group = $("#group").val();
                        ...
                        if (button == 'btn_add') {
                            ...
                            var content = $("#content");
                            var site = "mod_attendance/index.php/trx03a/home/addnew";
                            ...
                            var content = $("#content");
                            var site = "mod_attendance/index.php/trx03a/home/edit";
                                        ...
                                        $("#dialog-confirm").dialog({
                                            ...
                                            buttons: {
                                                "Delete ": function() {
                                                    $.ajax({
                                                        type: "POST",
                                                        url: '<?php echo site_url('trx03a/home/delete') ?>' + '/' + id,
                                                        dataType: "json",
                                                        cache: false,
                                                        success:
                                                                function(data) {
                            ...
                            window.location.href = '<?php echo site_url('trx03a/home/exportdata') ?>'+'/'+group;
                            ...
                            $(document).ready(function()
                            {
                                var url_print = '<?php echo site_url('trx03a/home/iframe') ?>';
                                //alert(url_print + "/" + id);
                                $.ajax({
                                    type: "POST",
                                    url: url_print + "/" + id,
