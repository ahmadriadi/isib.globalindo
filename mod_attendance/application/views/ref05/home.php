...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data Parameter Presence</h4>                
            </div>
...
?>
                    ...
                    function reloadpage() {
                        ...
                        var url = ROOT.base_url + 'mod_attendance/index.php/ref05/home/';
                        //alert(url);
                        content.load(url);
                    }
                    function backtohome() {
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('ref05/home/getdatatable') ?>';
                        ...
                        var oTable = $('#tableajax').dataTable({
                            ...
                            "aoColumns": [
                                ...
                                {"mData": "ParamDate", "sTitle": "Date", "sClass": "left"},
                                {"mData": "Lokasi", "sTitle": "Location", "sClass": "left"},
                                {"mData": "ParamWorkHour", "sTitle": "Work Hour", "sClass": "left"},
                            ...
                            "fnDrawCallback": function(oSettings) {
                                ...
                                $("#tableajax tbody tr ").on('mouseenter', 'button', function() {
                                    ...
                                    $.ajax(
                                            {
                                                type: "POST",
                                                url: '<?php echo site_url('ref05/home/get_access') ?>',
                                                dataType: "json",
                                                data: "btn=" + button,
                                                cache: false,
                                                success:
                    ...
                    function reply_click(clicked_id)
                    {
                        ...
                        if (button == 'btn_add') {
                            var content = $("#content");
                            var site = "mod_attendance/index.php/ref05/home/addnew";
                            ...
                            var content = $("#content");
                            var site = "mod_attendance/index.php/ref05/home/edit";
                                    ...
                                    $("#dialog-confirm").dialog({
                                        ...
                                        buttons: {
                                            "Delete ": function() {
                                                $.ajax({
                                                    type: "POST",
                                                    url: '<?php echo site_url('ref05/home/delete') ?>' + '/' + id,
                                                    dataType: "json",
                                                    cache: false,
                                                    success:
                                                            function(data) {
                            ...
                            window.location.href = '<?php echo site_url('ref05/home/excel') ?>';
