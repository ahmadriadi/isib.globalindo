...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data Type Attendance</h4>                
            </div>
             ...
             <?php 
                ...
                ?>
                    ...
                    function reloadpage() {
                        ...
                        var url = ROOT.base_url + 'mod_attendance/index.php/ref02/home/';
                        //alert(url);
                        content.load(url);
                    }
                    function backtohome() {
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('ref02/home/dataattendance') ?>';
			    ...
			    "sPaginationType2": "bootstrap",
                            ...
                            "aoColumns": [
                                ...
                                {"mData": "IDType", "sTitle": "Code", "sClass": "left"},
                    ...
                    function reply_click(clicked_id)
                    {
                        ...
                        if (button == 'btn_add') {
                            var content = $("#content");
                            var site = "mod_attendance/index.php/ref02/home/addnew";
                            ...
                            var content = $("#content");
                            var site = "mod_attendance/index.php/ref02/home/edit";
                            ...
                            window.location.href = '<?php echo site_url('ref02/home/excel') ?>';
