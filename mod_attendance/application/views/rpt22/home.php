...
<div class="box-generic">
    ...
    <div class="tabsbar">
        <ul>
            <li class="glyphicons tag active"><a href="#presencejurnal" data-toggle="tab"><i></i>REPORT LIST EMPLOYEE<strong></strong></a></li>
        </ul>
    </div>
    <!-- // Tabs Heading END -->
                ...
                <div class="widget-body">
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f02">Filter by</label>
                                <div class="controls">
                                    <?php
                                    $no = 'A';
...
?>
    ...
    $(document).ready(function() {
        ...
        process.click(function() {
            var url_presence = '<?php echo site_url('rpt22/home/presencedata') ?>';
            var date = $("#f01").val();
            var group = $('input:radio[name=f02]:checked').val();
            var content = $("#content .innerLR");
            var site = 'mod_attendance/index.php/rpt22/home/iframedata/' + date + '/'  + '/' + group;
            var url = ROOT.base_url + site;

            var url_post = url_presence + '/' + date + '/' + group;
            $.ajax(
                    {
                        type: "POST",
                        url: url_post,
