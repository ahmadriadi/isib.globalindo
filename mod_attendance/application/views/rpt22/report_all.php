    ...
    <body bgcolor="#FFFFFF">
        <div id="print_area" >
            ...
            <table style="page-break-after:always; " width="100%">
                ...
                <tr width="100%">
                    <th width="50px" colspan="12">LIST OF EMPLOYEE</th>                                    
                </tr>
                <tr width="100%">
                    <th width="50px" colspan="6" >Employee Active</th>                                    
                    <th width="50px" colspan="6" >Employee Passive</th>                                    
                </tr>
                <tr width="100%">                    
                    ...
                    <td colspan="6" valign="top">
                        <table width="100%" cellpadding="0" cellspacing="0" style="top: ">
                            <tr>
                                ...
                                <th width="50px">Group</th>                                    
                                <th width="50px">Departement</th>                                    
                                <th width="50px">Resigndate</th>  
                            </tr>

                            <?php
                            if ($resultpassive !== 'empty') {
                                $noresign = 0;
                                foreach ($resultpassive as $row) {
                                    $nip = $row['IDEmployee'];
                                    $name = $row['FullName'];
                                    $group = $this->libfun->get_name_group($row['IDJobGroup']);
                                    $unit = $row['DescStructure'];
                                    ...
                                    $checkhire = ($hiredate == '' or $hiredate == NULL) ? 'empty' : 'exist';
                                    $checkresign = ($resigndate == '' or $resigndate == NULL) ? 'empty' : 'exist';
