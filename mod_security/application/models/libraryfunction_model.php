...
function mincurday() {
$untildate = date('d-m-Y', strtotime(date('Y-m-d')));
$from = date('d-m-Y', strtotime("-1 day", strtotime(date('Y-m-d'))));
return $from . " " . $untildate;
}
...
function selisihwaktu($time1, $time2, $precision = 6) {
// Set timezone
...
sample
 *
echo selisihwaktu("2010-01-26", "2004-01-26") . "\n"; 
echo selisihwaktu("2006-04-12 12:30:00", "1987-04-12 12:30:01") . "\n"; 
echo selisihwaktu("now", "now +2 months") . "\n"; 
echo selisihwaktu("now", "now -6 year -2 months -10 days") . "\n";
echo selisihwaktu("2009-01-26", "2004-01-26 15:38:11") . "\n";
 * 
 Hasil di broser :
6 years
