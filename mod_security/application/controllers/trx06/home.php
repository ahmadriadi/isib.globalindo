...
class Home extends CI_Controller {
   ...
   function anti_xss($source)
    ...
    function index() {
        $this->load->view('trx06/home');
    }

    function dataauthorization_print() {
        echo $this->authorization->dataprint();
    }
    ...
    function addpost() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $rowlogin = $this->authorization->check_access_print($f01);
            $check = ($rowlogin == '' or $rowlogin == null) ? 'empty' : 'exist';
            if ($check == 'empty') {              
                $this->authorization->insert_print($record);
    ...
    function edit($id) {
        ...
        $row = $this->authorization->get_by_id_print($id);
    ...
    function editpost() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $this->authorization->update_print($id, $record);
    ...
    function delete($id) {
        $this->authorization->delete_print($id);
