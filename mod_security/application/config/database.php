...
$public     = "isib_public";
$hispublic     = "isib_public_history";
$it   = "isib_it_sysdev";

$active_group = "empcenter";
$active_record = TRUE;
...
$db['hispublic']['hostname'] = $hostname;
$db['hispublic']['username'] = $username;
$db['hispublic']['password'] = $password;
$db['hispublic']['database'] = $hispublic;
$db['hispublic']['dbdriver'] = "mysql";
$db['hispublic']['dbprefix'] = "";
$db['hispublic']['pconnect'] = FALSE;
$db['hispublic']['db_debug'] = TRUE;
$db['hispublic']['cache_on'] = FALSE;
$db['hispublic']['cachedir'] = "";
$db['hispublic']['char_set'] = "utf8";
$db['hispublic']['dbcollat'] = "utf8_general_ci";
$db['hispublic']['client_flags'] = 128;
