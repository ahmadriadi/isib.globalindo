...
<div id="content-wrap">
        ...
        <div class="widget"
            ...
            <form name="form" action="" method="POST" enctype="multipart/form-data">
                <div class="widget-body">
                    ...
                    <table border="1">
                        <tr>
                            <td width="10%" align="center">PostingDate</td>
                            <td width="10%" align="center">IDEmployee</td>
                            <td width="10%" align="center">Amount</td>
                            <td width="10%" align="center">Parameter</td>
                            <td width="10%" align="center">FlagLoan</td>
                            <td width="10%" align="center">Note</td>
                           
                        </tr>
                        <tr>
                            <td align="center">2014-11-24</td>
                            <td align="center" >0506021112</td>
                            <td align="center" >100000</td>
                            <td align="center" >LOAN</td>
                            <td align="left" >Request</td>
                            <td align="right" >Potongan pembelian barang</td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function()
        {
            ...
            var site = 'mod_security/index.php/imp05/home';
