                ...
                <div class="widget-body">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            ...
                            <!-- Group end -->    
                            <!-- Group -->
                            <?php if( $flagposition=='add'){ ; ?>
                            <div class="control-group">
                                <label class="control-label" for="f03">Common Access</label>
                                <div class="controls">
                                     <?php
                                    $no = 'A';
...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
	 ...
	 $.ajax({
	    url: '<?php echo site_url('trx04/home/autocomplete_employee'); ?>',
	    dataType: 'json',
	    success: function(d) {
		var data = d;
		$('#f02').typeahead({
