...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data User Login</h4>                
            </div>
    ...
    <script type="text/javascript">
                    ...
                    function reloadpage() {
                        ...
                        var url = ROOT.base_url + 'mod_security/index.php/trx04/home/';
                        //alert(url);
                        content.load(url);
                    }
                    function backtohome() {
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('trx04/home/datauserlogin') ?>';
                        ...
                        var oTable = $('#tableajax').dataTable({
                            ...
                            "aoColumns": [
                                ...
                                {"mData": "Username", "sTitle": "Username", "sClass": "left"},                             
                                {"mData": "FullName", "sTitle": "Name", "sClass": "left"},
                                {"mData": "JobGroup", "sTitle": "Group", "sClass": "left"},
                                {"mData": "RoleUser", "sTitle": "Role Access", "sClass": "left"},
                            ],
                    ...
                    function reply_click(clicked_id)
                    {
                        ...
                        if (button == 'btn_add') {
                            var content = $("#content");
                            var site = "mod_security/index.php/trx04/home/addnew";
                            var url = ROOT.base_url + site;
                            content.load(url);
                        } else if (button == 'btn_edit') {
                            var content = $("#content");
                            var site = "mod_security/index.php/trx04/home/edit";
                            ...
                            $(document).ready(function()
                            {
                                ...
                                var site = 'mod_security/index.php/trx04/home';
                            ...
                            $(document).ready(function()
                            {
                                var url_print = '<?php echo site_url('trx04/home/iframe') ?>';
                                //alert(url_print + "/" + id);
                                $.ajax({
                                    type: "POST",
                                    url: url_print + "/" + id,
