...
function buildtable(){
    var dataajax    = "<?php echo site_url()?>/trx10/home/get_data/3";
//    alert(dataajax);
    var table = $('#table_unsolvedrpt').dataTable({
        "bJQueryUI": false,
        "bSortClasses": false,
        "aaSorting": [[2, "desc" ]],
        "bAutoWidth": false,
...
//            alert(d.toSource());
        ...
        "fnDrawCallback": function(oSettings) {
            ...
            $("#table_unsolvedrpt>tbody>tr").attr("sub","close");
            $("#table_unsolvedrpt>tbody>tr").addClass("selectable");
            $("#table_unsolvedrpt>tbody>tr.selectable").click(function (){
...
<div class="row-fluid">
    <div class="span12">
        <table width="100%" id="table_unsolvedrpt" class="table-bordered table-condensed table-primary"></table>
    </div>
</div>
