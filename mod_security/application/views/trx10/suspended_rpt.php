...
function buildtable(){
    var dataajax    = "<?php echo site_url()?>/trx10/home/get_data/2";
//    alert(dataajax);
    var table = $('#table_suspendedrpt').dataTable({
        "bJQueryUI": false,
        "bSortClasses": false,
        "aaSorting": [[2, "desc" ]],
        "bAutoWidth": false,
...
//            alert(d.toSource());
        ...
        "fnDrawCallback": function(oSettings) {
            ...
            $("#table_suspendedrpt>tbody>tr").attr("sub","close");
            $("#table_suspendedrpt>tbody>tr").addClass("selectable");
            $("#table_suspendedrpt>tbody>tr.selectable").click(function (){
...
<div class="row-fluid">
    <div class="span12">
        <table width="100%" id="table_suspendedrpt" class="table-bordered table-condensed table-primary"></table>
    </div>
</div>
