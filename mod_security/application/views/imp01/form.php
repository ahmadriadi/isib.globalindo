...
<div id="content-wrap">
        ...
        <div class="widget"
            ...
            <form name="form" action="" method="POST" enctype="multipart/form-data">
                <div class="widget-body">
                    ...
                    <table border="1">
                        <tr>
                            <td width="10%" align="center">KODE DIVRE</td>
                            <td width="10%" align="center" >NAMA REGIONAL</td>
                            <td width="10%" align="center">NAMA KC</td>
                            <td width="10%" align="center">NAMA DATI2</td>
                            <td width="10%" align="center">KODE FASKES</td>
                            <td width="10%" align="center">NAMA FASKES</td>
                            <td width="10%" align="center">JENIS </td>
                            <td width="10%" align="center">ALAMAT FASKES</td>
                        </tr>
                        <tr>
                            <td align="center">04</td>
                            <td align="left" >REGIONAL   IV - JAKARTA</td>
                            <td align="left">JAKARTA TIMUR</td>
                            <td align="left">KOTA JAKARTA TIMUR</td>
                            <td align="center">01130034</td>
                            <td align="left">POLRES JAKARTA TIMUR</td>
                            <td align="left">KLINIK POLRI </td>
                            <td align="left">JL. MATRAMAN RAYA NO. 224 </td>
                        </tr>
                    </table>
                    <br/><br/><br/>
                    <!-- Row -->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function()
        {
            ...
            var site = 'mod_security/index.php/imp01/home';
