...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data User Parameter</h4>                
            </div>
    ...
    <script type="text/javascript">
                    ...
                    function reloadpage() {
                        ...
                        var url = ROOT.base_url + 'mod_security/index.php/trx05/home/';
                        //alert(url);
                        content.load(url);
                    }
                    function backtohome() {
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('trx05/home/dataparameterdata') ?>';
                        ...
                        var oTable = $('#tableajax').dataTable({
                            ...
                            "aoColumns": [
                                ...
                                {"mData": "IDParam", "sTitle": "Code", "sClass": "left"},
                                {"mData": "ParamValue", "sTitle": "IDEmployee", "sClass": "left"},
                    ...
                    function reply_click(clicked_id)
                    {
                        ...
                        if (button == 'btn_add') {
                            var content = $("#content");
                            var site = "mod_security/index.php/trx05/home/addnew";
                            var url = ROOT.base_url + site;
                            content.load(url);
                        } else if (button == 'btn_edit') {
                            var content = $("#content");
                            var site = "mod_security/index.php/trx05/home/edit";
                                    ...
                                    $("#dialog-confirm").dialog({
                                        ...
                                        buttons: {
                                            "Delete ": function() {
                                                $.ajax({
                                                    type: "POST",
                                                    url: '<?php echo site_url('trx05/home/delete') ?>' + '/' + id,
                                                    dataType: "json",
                                                    cache: false,
                                                    success:
                                                            function(data) {
                            ...
                            window.location.href = '<?php echo site_url('trx05/home/exportdata') ?>';
                            ...
                            $(document).ready(function()
                            {
                                var url_print = '<?php echo site_url('trx05/home/iframe') ?>';
                                //alert(url_print + "/" + id);
                                $.ajax({
                                    type: "POST",
                                    url: url_print + "/" + id,
