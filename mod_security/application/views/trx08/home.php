...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">User for Logistic Cancellation</h4>                
            </div>
    ...
    <script type="text/javascript">
                    ...
                    function reloadpage() {
                        ...
                        var url = ROOT.base_url + 'mod_security/index.php/trx08/home/';
                        //alert(url);
                        content.load(url);
                    }
                    function backtohome() {
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('trx08/home/dataauthorization_cancel') ?>';
                    ...
                    function reply_click(clicked_id)
                    {
                        ...
                        if (button == 'btn_add') {
                            var content = $("#content");
                            var site = "mod_security/index.php/trx08/home/addnew";
                            var url = ROOT.base_url + site;
                            content.load(url);
                        } else if (button == 'btn_edit') {
                            var content = $("#content");
                            var site = "mod_security/index.php/trx08/home/edit";
                            ...
                            $(document).ready(function()
                            {
                                ...
                                var site = 'mod_security/index.php/trx08/home';
                            ...
                            window.location.href = '<?php echo site_url('trx08/home/exportdata') ?>';
