...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data User Email Root Cause</h4>                
            </div>
    ...
    <script type="text/javascript">
                    ...
                    function reloadpage() {
                        ...
                        var url = ROOT.base_url + 'mod_security/index.php/ref02/home/';
                        //alert(url);
                        content.load(url);
                    }
                    function backtohome() {
                    ...
                    function reply_click(clicked_id)
                    {
                        ...
                        if (button == 'btn_add') {
                            var content = $("#content");
                            var site = "mod_security/index.php/ref02/home/addnew";
                            var url = ROOT.base_url + site;
                            content.load(url);
                        } else if (button == 'btn_edit') {
                            var content = $("#content");
                            var site = "mod_security/index.php/ref02/home/edit";
                            ...
                            $(document).ready(function()
                            {
                                var url_print = '<?php echo site_url('ref02/home/iframe') ?>';
                                //alert(url_print + "/" + id);
                                $.ajax({
                                    type: "POST",
                                    url: url_print + "/" + id,
