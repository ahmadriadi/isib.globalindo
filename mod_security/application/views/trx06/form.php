...
<div id="content-wrap">
    <h3>Form : User for Logistic Printing</h3>
    <div class="innerLR">
        <!-- Form -->
        <form class="form-horizontal" style="margin-bottom: 0;" id="validateSubmitForm" method="get" autocomplete="off">
            ...
            <div class="widget"
                 ...
                 <div class="widget-head">
                    <h4 class="heading">User for Logistic Printing</h4>
                </div>
                <!-- // Widget heading END -->
                <div class="widget-body">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            ...
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f02">Full Name</label>
                                <div class="controls">
...
<script type="text/javascript">
	...
	*/
	  ...
	  $.ajax({
	    url: '<?php echo site_url('trx06/home/autocomplete_employee'); ?>',
	    dataType: 'json',
	    success: function(d) {
		var data = d;
		$('#f02').typeahead({
