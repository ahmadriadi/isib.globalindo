...
$public       = "isib_public";
$logistic     = "isib_logistic";
$attendance   = "isib_attendance";
$it   = "isib_it_sysdev";
$ithis   = "isib_it_sysdev_history";



$active_group = 'itsysdev';
$active_record = TRUE;
...
$db['itsysdev']['hostname'] = $hostname;
$db['itsysdev']['username'] = $username;
$db['itsysdev']['password'] = $password;
$db['itsysdev']['database'] = $it;
$db['itsysdev']['dbdriver'] = "mysql";
$db['itsysdev']['dbprefix'] = "";
$db['itsysdev']['pconnect'] = FALSE;
$db['itsysdev']['db_debug'] = TRUE;
$db['itsysdev']['cache_on'] = FALSE;
$db['itsysdev']['cachedir'] = "";
$db['itsysdev']['char_set'] = "utf8";
$db['itsysdev']['dbcollat'] = "utf8_general_ci";
$db['itsysdev']['client_flags'] = 128;

$db['itsysdevhis']['hostname'] = $hostname;
$db['itsysdevhis']['username'] = $username;
$db['itsysdevhis']['password'] = $password;
$db['itsysdevhis']['database'] = $ithis;
$db['itsysdevhis']['dbdriver'] = "mysql";
$db['itsysdevhis']['dbprefix'] = "";
$db['itsysdevhis']['pconnect'] = FALSE;
$db['itsysdevhis']['db_debug'] = TRUE;
$db['itsysdevhis']['cache_on'] = FALSE;
$db['itsysdevhis']['cachedir'] = "";
$db['itsysdevhis']['char_set'] = "utf8";
$db['itsysdevhis']['dbcollat'] = "utf8_general_ci";
$db['itsysdevhis']['client_flags'] = 128;
