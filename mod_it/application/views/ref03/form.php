                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">                              
                            ...
                            <div class="control-group">
                                <label class="control-label" for="f01">Computer Name</label>                               
                                <div class="controls">
                            ...
                            <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f02">IP Address</label>                               
                                <div class="controls">
                        ...
                        <div class="span6">   
                             <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f03">Port</label>                               
                                <div class="controls">
                            ...
                            <!-- Group end -->    
                             ...
                             <!-- Group -->
                            <div class="control-group">
                                <label class="control-label" for="f04">Printer Name</label>                               
                                <div class="controls">
    ...
    $(document).ready(function()
    {
        ...
        save.click(
                function()
                {
                    ...
                    var site = 'mod_it/index.php/ref03/home';
