...
<!-- Table -->
<table  id="tableajaxipactive" cellspacing="0" cellpadding="0" class=" table table-bordered table-condensed table-striped table-primary table-vertical-center js-table-sortable" >
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var dataajaxipactive = '<?php echo site_url('mst02/home/getdatatable') ?>'+'/ipactive';
        var oTable = $('#tableajaxipactive').dataTable({
            "bJQueryUI": false,
            "iDisplayLength": 10,
            ...
            "fnDrawCallback": function (oSettings) {
                $("#tableajaxipactive tbody tr ").on('click', 'button', function () {
                ...
                $("#tableajaxipactive tbody tr").on('mouseenter', function () {
                    $('#tableajaxipactive tbody tr').addClass("selectable");

                });
                $('#tableajaxipactive tbody tr').on('click', function () {
                   // var nTds = $('td', this);
                  //  var id = $(nTds[12]).text();
                  //  detail(id)
                   // return false;
                ...
                $("#tableajaxipactive tbody tr ").on('mouseenter', 'button', function () {
                    var button = $(this).attr("btn");
