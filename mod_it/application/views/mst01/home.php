...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data Master Inventaris</h4>                
            </div>
...
?>
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('mst01/home/getdatatable') ?>';
                            ...
                            "aoColumns": [
                                {
                                    ...
                                    "mRender": function(aoData) {
                                        return "<div class='btn-group'>\n\
                                                        ...
                                                        <button btn='btn_barcode' idbtn=" + aoData + "  type='button' class='btn btn-mini btn-info'><i class='icon-barcode'></i></button>\n\
                                                        <button btn='btn_delete' idbtn=" + aoData + "  type='button' class='btn btn-mini btn-danger'><i class='icon-trash'></i></button>\n\
                                                        </div>\n\
                                                        ";
                                    }
                                },
                                {"mData": "CounterCode", "sTitle": "Code Item", "sClass": "left"},
                    ...
                    function reply_click(clicked_id)
                    {
                        ...
                        if (button == 'btn_add') {
                            var content = $("#content");
                            var site = "mod_it/index.php/mst01/home/addnew";
                            ...
                            var content = $("#content");
                            var site = "mod_it/index.php/mst01/home/edit";
                            var url = ROOT.base_url + site + "/" + id;
                            content.fadeOut("slow", "linear");
                            content.load(url);
                            content.fadeIn("slow");

                        } else if (button == 'btn_barcode') {
                            var content = $("#content");
                            var site = "mod_it/index.php/mst01/home/getprinter";
                            var url = ROOT.base_url + site + "/" + id;
                            content.fadeOut("slow", "linear");
                            content.load(url);
                            content.fadeIn("slow");
                            ...
                            window.location.href = '<?php echo site_url('mst01/home/excel') ?>';
