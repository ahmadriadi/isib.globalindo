...
//                    alert(isinew);
            ...
            $("#nmparent").autocomplete({
             ...
             $("#nmleader").autocomplete({
                source  : employees,
                select  : function (event,ui){
                    $("#idleader").val(ui.item.IDEmployee);
                    $("#nmleader").hide({
                        easing : "slide",
                        duration : 300,
                        complete : function (){
...
//            job
			...
			if (data.IDEmployee == null){
				...
				$("#idemp").keydown(false);
                        ...
                        if(data.IDEmployeePTL ==null || data.IDEmployeePTL ==''){
                            $(".idleader").addClass("idleader_null");
                        }else{
                             $(".idleader").addClass("idleader_exist");
                        }
                            
                           
                           
                        $("#idparent").val(data.IDEmployeeParent);
                        $("#idleader").val(data.IDEmployeePTL);
            ...
            function save_job(){
                ...
                $.ajax({
                    ...
                    data    : "empstat="+empstat.toUpperCase()+"&idleader="+idleader+"&idparent="+idparent+"&jobloc="+jobloc+"&jobgrp="+jobgrp+"&depart="+depart+"&jobpos="+jobpos.toUpperCase()+"&unitjob="+unitjob.toUpperCase(),
                    type    : "post",
                    dataType: "json",
                    cache   : false,
                    success : function (data){
			...
			//alert(data);
                        if (data.status == "oke"){
                            ...
                            if (data.flagsales =='required' && data.idleader !==''){
                                upd_ftab("2f1");
                                upd_ftab("2f2");
                                $(".alert-tab2").remove();
                                $(".ifnol").hide();
                                $(".idleader").removeClass("idleader_null");
                                $(".idleader").addClass("idleader_exist");
                                unbindformjob();
                                
                            }else if(changes == "1" && data.flagsales !=='norequired'){
                                upd_ftab("2f1");
                                $(".alert-tab2").remove();
                                $(".ifnol").hide();
                                unbindformjob();                             
...
//                        alert($(this).attr("id"));
            ...
            function cekformjob(){
                ...
                $.ajax({
                    ...
                    data    : "empstat="+empstat.toUpperCase()+"&idparent="+idparent+"&idleader="+idleader+"&jobloc="+jobloc+"&jobgrp="+jobgrp+"&depart="+depart+"&jobpos="+jobpos.toUpperCase()+"&unitjob="+unitjob.toUpperCase(),
                    type    : "post",
                    dataType: "json",
                    cache   : false,
                    success : function (data){
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span3">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="noakdhk" class="span12 fistp2" tstp="2">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="widget widget-body jobdtl">
                            <div class="row-fluid">
                                <div class="span8">
                                    ...
                                    <?php if($flagsales=='required'){ ?>
                                    <!--===================-->
                                    <div class="row-fluid">
                                        <div class="span8">
                                            <div class="control-group">
                                                <label for="idleader"><b><span class='idleader'>Project Leader</span></b> / <i class="transindo"><span class='idleader'>NIP Project Leader</span></i></label>
                                                <div class="controls">
                                                    <input type="text" class="span6" id="idleader">
                                                    <input type="text" class="span6 upper fijob" id="nmleader" placeholder="[Name]">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
