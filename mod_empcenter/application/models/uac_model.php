...
class Uac_Model extends CI_Model {
    ...
    function getdata_button($iduser,$idmenu,$button){
         $q  = "SELECT 
                    b.ButtonDesc as btndesc,
                    b.KdButton as kdbutton, 
                    a.IDButton as idbutton, 
                    a.IDMenu as idmenu,
                    a.Access as access 
                FROM
                    $this->_tbl5 a 
                ...
                ON 
                    ...
                    a.IDButton = b.IDButton 
                WHERE 
                    a.IDUser = '$iduser' AND 
                    a.IDMenu = '$idmenu' AND
                    b.KdButton = '$button' AND
                    a.Access ='1'    
                 ";
