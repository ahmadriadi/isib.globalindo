...
<div id="content-wrap">
    <h2>Field Payroll <span>Reference Additonal</span></h2> 
    <div class="innerLR">
        <!-- Form -->
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                 <textarea id="f02" name="f02" cols="18" rows="3"<?php echo (isset($default['readonly_f02'])) ? $default['readonly_f02'] : ''; ?> ><?php echo (isset($default['f02'])) ? $default['f02'] : ''; ?></textarea>                                          
                                </div>                        
                            </div> 
                            <!-- Group end -->  
                        </div>
