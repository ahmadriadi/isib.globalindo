...
<div class="widget">
    ...
    <div class="widget-head">
        <h4 class="heading">Data Reference Additional</h4>
    </div>
    ...
    <script type="text/javascript">
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('ref01/home/dataadditional') ?>';
                    ...
                    function reply_click(clicked_id)
                    {
                        ...
                        if (button == 'btn_add') {
                            ...
                            var content = $("#content");
                            var site = "mod_fieldpayroll/index.php/ref01/home/addnew";
                            ...
                            var content = $("#content");
                            var site = "mod_fieldpayroll/index.php/ref01/home/edit";
                            ...
                            var content = $("#content");
                            var site = "mod_fieldpayroll/index.php/ref01/home/checkdata";
                            var url = ROOT.base_url + site + "/" + id;
                            content.fadeOut("slow", "linear");
                            content.load(url);
                            content.fadeIn("slow");
                            ...
                            $(document).ready(function()
                            {
                                ...
                                var site = 'mod_fieldpayroll/index.php/ref01/home';
                                var urldel = ROOT.base_url + site;


                                // alert('<?php //echo site_url('ref01/home/delete')  ?>'+'/'+id);
                            ...
                            window.location.href = '<?php echo site_url('ref01/home/exportdata') ?>';
