...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data Daily Salary</h4>                
            </div>
		   ...
		   <?php 
                       ...
                       ?>
                        ...
                        function reloadpage() {
                            ...
                            var url = ROOT.base_url + 'mod_fieldpayroll/index.php/trx01/home/';
                            //alert(url);
                            content.load(url);
                        }
                        function backtohome() {
                        ...
                        $(document).ready(function() {
                            ...
                            var dataajax = '<?php echo site_url('trx01/home/resultdailysalary') ?>';
				    ...
				    {"mData": "IDJobGroup", "sTitle": "ID Group", "sClass": "left"},
                                    ...
                                    {"mData": "PresenceStatus", "sTitle": "PresenceStatus", "sClass": "center"},
                                    {"mData": "DailySalaryPayment", "sTitle": "DailySalaryPayment", "sClass": "right"},
                                    {"mData": "MontlyPayment", "sTitle": "MontlyPayment", "sClass": "right"},
                                    {"mData": "DailyIncentiveShift", "sTitle": "DailyIncentiveShift", "sClass": "right"},
                            ...
                            var content = $("#content");
                            var site = "mod_fieldpayroll/index.php/trx01/home";
			  ...
			  $('select#group').on('change',function(){
			    ...
			    var group = $("#group").val();	
                             ...
                             if (button == 'btn_excel') {
                                window.location.href = '<?php echo site_url('trx01/home/exportdata') ?>'+'/'+group;
