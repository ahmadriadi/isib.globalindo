...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data Daily Overtime</h4>                
            </div>
    ...
    <script type="text/javascript">
			 <?php 
                        ...
                        function reloadpage() {
                            ...
                            var url = ROOT.base_url + 'mod_fieldpayroll/index.php/trx02/home/';
                            //alert(url);
                            content.load(url);
                        }
                        function backtohome() {
                        ...
                        $(document).ready(function() {
                            ...
                            var dataajax = '<?php echo site_url('trx02/home/resultdailyovertime') ?>';
				...
				"sPaginationType2": "bootstrap", 
				    ...
				    {"mData": "IDJobGroup", "sTitle": "ID Group", "sClass": "left"},	
                                    ...
                                    {"mData": "PresenceDate", "sTitle": "PresenceDate", "sClass": "center", sType: 'date-eu'},
                                    {"mData": "OvertimeIn", "sTitle": "OvertimeIn", "sClass": "left"},
                                    {"mData": "OvertimeOut", "sTitle": "OvertimeOut", "sClass": "left"},
                                    {"mData": "OvertimeHour", "sTitle": "OvertimeHour", "sClass": "right"},
                                    {"mData": "OvertimeTotalHour", "sTitle": "OvertimeTotalHour", "sClass": "right"},
                                    {"mData": "OvertimePerHour", "sTitle": "OvertimePerHour", "sClass": "right"},
                                    {"mData": "PaymentStatus", "sTitle": "PaymentStatus", "sClass": "center"},
                                    {"mData": "DailyOvertimePayment", "sTitle": "DailyOvertimePayment", "sClass": "right"},
                                    {"mData": "OvertimeIncentive", "sTitle": "OvertimeIncentive", "sClass": "right"}
                            ...
                            var url_periode = '<?php echo site_url('trx02/home/set_pattern_date') ?>';
                            var content = $("#content");
                            var site = "mod_fieldpayroll/index.php/trx02/home";
			    ...
			    var group = $("#group").val();
                             ...
                             if (button == 'btn_excel') {
                                window.location.href = '<?php echo site_url('trx02/home/exportdata') ?>'+'/'+group;
