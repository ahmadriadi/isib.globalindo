...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data Additional Permanent</h4>                
            </div>
...
?>
                    ...
                    function reloadpage() {
                        ...
                        var url = ROOT.base_url + 'mod_fieldpayroll/index.php/trx04/home/';
                        //alert(url);
                        content.load(url);
                    }
                    function backtohome() {
                    ...
                    $(document).ready(function() {
                        ...
                        var dataajax = '<?php echo site_url('trx04/home/resultinsentif') ?>';
                    ...
                    function reply_click(clicked_id)
                    {
                        ...
                        if (button == 'btn_add') {
                            var content = $("#content");
                            var site = "mod_fieldpayroll/index.php/trx04/home/addnew";
                            ...
                            var content = $("#content");
                            var site = "mod_fieldpayroll/index.php/trx04/home/edit";
                            ...
                            $(document).ready(function()
                            {
                                ...
                                var site = 'mod_fieldpayroll/index.php/trx04/home';
