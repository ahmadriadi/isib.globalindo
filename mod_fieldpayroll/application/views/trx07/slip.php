...
<table width="100%" border="0" cellpadding="4" cellspacing="2" style="border-collapse:collapse;">
    <tr>
        <td><strong>SLIP GAJI "PT.TRIAS INDRA SAPUTRA"</strong></td>
    </tr>
    <tr>
        <td>
            <table width="100%" border="0" cellpadding="2" cellspacing="2" style="border-collapse:collapse;">
                ...
                <tr>
                    ...
                    <td width="2%">:</td>
                    <td width="37%"><?php echo $slip['Location'].'-'.$slip['IDUnitGroup'];?></td>
                </tr>
            </table>
        </td>
    </tr>
                ...
                <tr>
                    <td width="35%" align="left" valign="top">&nbsp;
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                            ...
                            <tr>
                                <td width="40%" align="left">Insentif Shift</td>
                                <td width="10%" align="center">:</td>
                                <td width="40%" align="right"><?php echo number_format($slip['SumDailyIncentiveShift']);?></td>
                            </tr>
                            <tr>
                                <td width="40%" align="left">Lembur</td>
                                <td width="10%" align="center">:</td>
                                <td width="40%" align="right"><?php echo number_format($slip['SumDailyOvertimePayment']);?></td>
                            </tr>
                            <tr>
                                <td width="40%" align="left">Tunjangan Lain-Lain</td>
                                <td width="10%" align="center">:</td>
                                <td width="40%" align="right"><?php echo number_format($slip['OtherIncome']);?></td>
                            </tr>
                            <tr>
                    ...
                    <td width="35%" align="left" valign="top">&nbsp;
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                            ...
                            <tr>
                                <td width="40%" align="left">Potongan Absensi</td>
                                <td width="10%" align="center">:</td>
                                <td width="40%" align="right"><?php echo number_format($slip['AbsencePayment']);?></td>
                            </tr>
                            <tr>
                                <td width="40%" align="left">Asuransi</td>
                                <td width="10%" align="center">:</td>
                                <td width="40%" align="right"><?php echo number_format($slip['InsurancePayment']);?></td>
                            </tr>
                            <tr>
                                <td width="40%" align="left">Potongan Pinjaman</td>
                                <td width="10%" align="center">:</td>
                                <td width="40%" align="right"><?php echo number_format($slip['LoanPayment']);?></td>
                            </tr>
                            <tr>
                                <td width="40%" align="left">Upah Sudah Dibayar </td>
                                <td width="10%" align="center">:</td>
                                <td width="40%" align="right"><?php echo number_format($slip['OutstandingPayment']);?></td>
                            </tr>
                            <tr>
                                <td width="40%" align="left">Potongan Lain-lain</td>
                                <td width="10%" align="center">:</td>
                                <td width="40%" align="right"><?php echo number_format($slip['OtherPayment']);?></td>
                            </tr>
                            <tr>
                                <td width="40%" align="left">&nbsp;</td>
                                <td width="10%" align="right">&nbsp;</td>
