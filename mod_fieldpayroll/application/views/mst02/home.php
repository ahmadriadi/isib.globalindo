        ...
        <div class="widget widget-tabs widget-tabs-double-2">
            <div class="widget-head">
                <ul>
                    ...
                    <li><a  class="glyphicons notes_2" href="#loaninterest" data-toggle="tab"><i></i><span>Loan Interest</span></a></li>
                </ul>
            </div>
            <div class="widget-body">
                <div class="tab-content">
                    ...
                    <!-------- ----------------Addition Discount Loan ----------------------------------------------------------->
                    <div id="loaninterest" class="tab-pane widget-body-regular">
                        <div class="btn-group">	 
        ...
        $(document).ready(function () {
            ...
            var oTable = $('#tableajaxinterest').dataTable({
                ...
                "aoColumns": [
                    ...
                    {"mData": "FlagProcess", "sTitle": "Process", "sClass": "left"},
...
?>
        ...
        function reply_click(clicked_id)
        {
            ...
            if (button == 'btn_add') {
                ...
                window.location.href = '<?php echo site_url('mst02/home/exportdata') ?>'+'/'+id;
