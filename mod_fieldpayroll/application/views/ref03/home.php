...
<div class="widget">
    ...
    <div class="widget-head">
        <h4 class="heading">Data Parameter Insentive</h4>
    </div>
    ...
    <script type="text/javascript">
                ...
                $(document).ready(function() {
                    ...
                    var dataajax = '<?php echo site_url('ref03/home/getdatatables') ?>';
                ...
                function reply_click(clicked_id)
                {
                    ...
                    if (button == 'btn_add') {
                        ...
                        var content = $("#content");
                        var site = "mod_fieldpayroll/index.php/ref03/home/addnew";
                        ...
                        var content = $("#content");
                        var site = "mod_fieldpayroll/index.php/ref03/home/edit";
                        ...
                        window.location.href = '<?php echo site_url('ref03/home/exportdata') ?>';
