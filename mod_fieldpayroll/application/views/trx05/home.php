...
<div class="widget">
    ...
    <div class="widget-head">
        <div class="row-fluid">
            <div class="span6">
                <h4 class="heading">Data Deduction</h4>                
            </div>
    ...
    <script type="text/javascript">
                        ...
                        function reloadpage() {
                            ...
                            var url = ROOT.base_url + 'mod_fieldpayroll/index.php/trx05/home/';
                            //alert(url);
                            content.load(url);
                        }
                        function backtohome() {
                        ...
                        $(document).ready(function() {
                            ...
                            var dataajax = '<?php echo site_url('trx05/home/resultdeduction') ?>';
				...
				"sPaginationType2": "bootstrap", 
                            ...
                            var content = $("#content");
                            var site = "mod_fieldpayroll/index.php/trx05/home";
			    ...
			    var group = $("#group").val();	
                             ...
                             if (button == 'btn_excel') {
                                window.location.href = '<?php echo site_url('trx05/home/exportdata') ?>'+'/'+group;
