...
class Home extends CI_Controller {
   ...
   function anti_xss($source)
    ...
    function dataadditional() {
        echo $this->reference->refadditional();
    }
    ...
    function addpost() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $this->reference->insert_additional($record);
    ...
    function edit($id) {
        ...
        $row = $this->reference->get_by_id_additional($id)->row();
    ...
    function editpost() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $this->reference->update_additional($id, $record);
            $this->logs->insert($recordlog);
    ...
    function delete($id) {
        $this->reference->delete_additional($id);
    ...
    function exportdata() {
        ...
        $result = $this->reference->get_alldata_additonal()->result_array();
        if ($result != NULL) {
            $i = 1;
