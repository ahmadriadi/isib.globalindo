...
$hisfieldpayroll   = "isib_fieldpayroll_history";
...
$db['hisfieldpayroll']['hostname'] = $hostname;
$db['hisfieldpayroll']['username'] = $username;
$db['hisfieldpayroll']['password'] = $password;
$db['hisfieldpayroll']['database'] = $hisfieldpayroll;
$db['hisfieldpayroll']['dbdriver'] = "mysql";
$db['hisfieldpayroll']['dbprefix'] = "";
$db['hisfieldpayroll']['pconnect'] = FALSE;
$db['hisfieldpayroll']['db_debug'] = TRUE;
$db['hisfieldpayroll']['cache_on'] = FALSE;
$db['hisfieldpayroll']['cachedir'] = "";
$db['hisfieldpayroll']['char_set'] = "utf8";
$db['hisfieldpayroll']['dbcollat'] = "utf8_general_ci";
$db['hisfieldpayroll']['client_flags'] = 128;
