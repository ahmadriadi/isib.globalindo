...
class Dailyovertime_model extends CI_Model {

    public function __construct() {
        parent::__construct();        
        $this->_db         =  $this->load->database('fieldpayroll', TRUE);       
        $this->_table      = 't02dailyovertime';
        $this->_employee   = 'triasnet_employee.m01personal';
       
    }
    
 function datadailyovertime($from,$until){            
      $a = $this->_table;   
      ...
      $this->datatables->select("$a.ID AS ID,
				 ...
				 $b.IDJobGroup AS IDJobGroup,
                                 ...
                                 $a.OvertimeTotalHour AS OvertimeTotalHour,                              
                                 $a.OvertimePerHour AS OvertimePerHour,                              
                                 $a.PaymentStatus AS PaymentStatus,                              
                                 $a.DailyOvertimePayment AS DailyOvertimePayment,                              
                                 $a.OvertimeIncentive AS OvertimeIncentive,                              
      ...
      $this->datatables->edit_column('DailyOvertimePayment', '$1', "number_format(DailyOvertimePayment,'2',',','.')");	
      $this->datatables->edit_column('OvertimeIncentive', '$1', "number_format(OvertimeIncentive,'2',',','.')");		
