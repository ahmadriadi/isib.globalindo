...
<div class="box-generic">
    ...
    <div class="tabsbar">
        <ul>
            <li class="glyphicons tag active"><a href="#presencejurnal" data-toggle="tab"><i></i>REPORT PRESENCE DETAIL<strong></strong></a></li>
        </ul>
    </div>
    <!-- // Tabs Heading END -->
...
<script>
	...
	/*
        var url_suggest = '<?php echo site_url('rpt01/home/suggest_employee'); ?>';
        $("#f03").autocomplete({
            minLength: 2,
	...
	*/
	 ...
	 $.ajax({
	    url: '<?php echo site_url('rpt01/home/autocomplete_employee'); ?>',
	    dataType: 'json',
	    success: function(d) {
		var data = d;
		$('#f03').typeahead({
        ...
        process.click(function() {
            ...
            if(f03){
                 ...
                 var nip = '<?php echo $this->session->userdata('sess_userid');?>';
            }
            
          
            var content = $("#content .innerLR");
            var site = 'mod_public/index.php/rpt01/home/iframedata/' +nip+'/'+ fromdate + '/' + untildate;
