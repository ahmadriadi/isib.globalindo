    ...
    <body bgcolor="#FFFFFF">
        <div id="print_area" >
            <table style="page-break-after:always; ">
                ...
                <tr width="100%">
                    ...
                    <th align="center" width="20px">MINUS</th>
                </tr>
                </thead>
                <!-- Dinamis -->
                ...
                foreach ($resultdata as $row) {
                    ...
                    $data['LateHour'] = decimaltominutes($late+0.01);
                    $LateHour_Sum+= $late;
                    ...
                    if ($description =='P') {
                       if ($actualhour <= 4) { 
                        ...
                        $data['A'] = 1;
                     	...
                     	//   echo $row['PresenceDate'].' - '.$description.'<br/>';
                        
                        
                        if($flag=='notnormal'){
                            $Minus_Count+= 1;
                            $data['MinusHour'] = 1;
                            $data['Note'] = 'LESS WORK HOUR : '.$rowparam->ParamWorkHour;
                        }else{
                        ...
                        $SN_Count+= 1;
                        $data['SN'] = 1;
                    }  elseif (substr($description, -1, 1) == 'L') {
                        $L_Count+= 1;
                        $data['L'] = 1;
                        ...
                        //$data['Presence'] = 1;
                    } elseif ($description = NULL AND ($in AND $out) != NULL  and $flag=='normal')  {
                        $P_Count+= 1;
                        $data['Presence'] = 1;
                        $data['Note'] = '';
                ...
                <tr width="100%" class="subfoot">                    
                    ...
                    <td align="right"><?php echo decimaltominutes($LateHour_Sum+0.01); ?></td>                    
        ...
        <script language="javascript">
            ...
            function exporttoexcel() {
                window.location.href = '<?php echo site_url('rpt01/home/excel/' . $nip . '/' . $from . '/' . $until); ?>';
            }
