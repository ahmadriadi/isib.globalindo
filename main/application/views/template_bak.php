        ...
        <div class="container-fluid fluid menu-left">
            ...
            <div id="wrapper">
                ...
                <div id="menu" class="hidden-phone hidden-print">
                    ...
                    <!-- Brand -->
                    <a href="<?php echo site_url(); ?>" class="appbrand">TIS <span>System Development <div id="ObserverElement"></div></span></a>
            ...
            <div id="footer" class="hidden-print">
                ...
                <!--  Copyright Line -->
                <div class="copy">&copy; 2019 - <a href="<?php echo site_url('sysdev'); ?>">System Development</a> - All Rights Reserved. <a href="http://www.triasindrasaputra.com" target="_blank">PT. Trias Indra Saputra</a> - Current version: v1.0  <a target="_blank" href="<?php echo site_url('changelog') ?>">changelog</a></div>
                <!--  End Copyright Line -->
